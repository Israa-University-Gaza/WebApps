...
public partial class Attendance_AbsentEmployees : System.Web.UI.Page
{
    ...
    protected void btnabsentReport_Click(object sender, EventArgs e)
    {
        ...
        a1.Add("AbsentEmployees");
        ArrayList a2 = new ArrayList();
        a2.Add(DataAccess.AbsentEmployeesGet(FromDate.Text, EndDate.Text, ddlEmpCategoryID.SelectedValue, Empstatus.SelectedValue,ddlEmpSubStatus.SelectedValue, ddlContractTypeID.SelectedValue, ddlSubContractType.SelectedValue));
        CreatePDF("AbsentEmployees", @"Reports\AbsentEmployees.rdlc", a1, a2);
    }
