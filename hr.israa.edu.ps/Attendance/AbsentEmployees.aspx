<%@ Page Title="" Language="C#" MasterPageFile="~/Attendance/MasterPage.master" AutoEventWireup="true" CodeFile="AbsentEmployees.aspx.cs" Inherits="Attendance_AbsentEmployees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">الغائبون</a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-reorder"></i>الغائبون </div>
            <div class="tools">
        ...
        <div class="portlet-body">
            <div class="form-group">
                ...
                <div class="form-group row">
                    <asp:Button ID="btnabsentReport" runat="server" Text="طباعة تقرير الغياب" class="btn green" OnClick="btnabsentReport_Click" />
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString='<%$ ConnectionStrings:HumanResources %>'
                                SelectCommand="AbsentEmployeesGet" SelectCommandType="StoredProcedure">
                                <SelectParameters>
