...
public partial class Attendance_LectureIrregularAddEdit : UserPage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            DataTable DT = DataAccess.LectureIrregularAddEdit(ddlSection.SelectedValue, txtLectureDate.Text, txtLectureTimeFrom.Text, txtLectureTimeTo.Text, UserID);
            if (DT.Rows.Count > 0)
            {
