<%@ Page Title="" Language="C#" MasterPageFile="~/EmpTasks/MasterPage.master" AutoEventWireup="true" CodeFile="TasksAllEmpViewDaily.aspx.cs" Inherits="EmpTasks_TasksAllEmpView" %>
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i>عرض مهمات الموظفين يوميا
                </div>
                <div class="tools">
            ...
            <div class="col-md-4">
                     ...
                     <label class="col-md-2 control-label">اختر التاريخ </label>
                 
                        <div class="col-md-4">
                            <asp:TextBox ID="Date" runat="server" OnTextChanged="Date_TextChanged" AutoPostBack="true"  data-date-format="yyyy/mm/dd" CssClass="form-control form-control-inline input-meduim date-picker" MaxLength="50"></asp:TextBox>
                        </div>
                    </div>
    ...
    <div class="portlet box green">
        ...
        <table  class="table table-striped table-hover" id="sample_editable_1 " >
            ...
            <tbody>
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:EmployeeTasks %>' SelectCommand="TasksAllEmpViewDaily" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownList2" PropertyName="SelectedValue" Name="EmployeeId" Type="Int32"></asp:ControlParameter>
                        <asp:ControlParameter ControlID="Date" PropertyName="Text" DbType="Date" Name="date"></asp:ControlParameter>
                    </SelectParameters>
                </asp:SqlDataSource>
            </tbody>
