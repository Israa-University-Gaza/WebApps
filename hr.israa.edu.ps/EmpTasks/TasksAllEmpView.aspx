<%@ Page Title="" Language="C#" MasterPageFile="~/EmpTasks/MasterPage.master" AutoEventWireup="true" CodeFile="TasksAllEmpView.aspx.cs" Inherits="EmpTasks_TasksAllEmpView" %>
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i>عرض مهمات الموظفين شهريا
                </div>
                <div class="tools">
            ...
            <div class="col-md-4">
                <asp:DropDownList ID="DDMonth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DDMonth_SelectedIndexChanged" class="form-control" placeholder="اختر الشهر" CssClass="select2_category form-control">
            ...
            <div class="col-md-4">
                <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="true" OnTextChanged="TextBox1_TextChanged" class="form-control"></asp:TextBox>
            </div>
        </div>
    ...
    <div class="portlet box green">
        ...
        <table  class="table table-striped table-hover" id="sample_editable_1 " >
            ...
            <tbody>
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:EmployeeTasks %>' SelectCommand="TasksAllEmpView" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownList2" PropertyName="SelectedValue" Name="EmployeeId" Type="Int32"></asp:ControlParameter>
                        <asp:ControlParameter ControlID="DDMonth" PropertyName="SelectedValue" Name="Month" Type="Int32"></asp:ControlParameter>
