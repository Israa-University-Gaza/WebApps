<%@ Page Title="" Language="C#" MasterPageFile="~/APP_HRM/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeExitAccrediate.aspx.cs" Inherits="APP_HRM_EmployeeExitAccrediate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">اعتماد الأذونات</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                ...
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>اعتماد الأذونات- صفحة المسئول المباشر</div>
                    <div class="tools">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 10%">تاريخ الاذن</th>
                                <th style="text-align: center; width: 10%">وقت الخروج المتوقع</th>
                                <th style="text-align: center; width: 10%">وقت العودة المتوقع</th>
                                <th style="text-align: center; width: 13%">سبب الخروج</th>
                                <th style="text-align: center; width: 10%">هاتف الاتصال</th>
                        ...
                        <tbody>
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource3">
                                <ItemTemplate>
                                    ...
                                    <td style="text-align: center"><span><%# Eval("ExitReason") %></span></td>
                                    ...
                                    <td style="text-align: center">
                                        <asp:LinkButton ID="lbAccrediate"  runat="server" class="btn default btn-xs black" OnClick="lbAccrediate_Click" Visible='<%# (Eval("IsDMAccredit").ToString() == "0" ) ? true:false %>'><i class="fa fa-check"></i> اعتماد</asp:LinkButton>
                                        <asp:LinkButton ID="lbRefuse" runat="server" class="btn default btn-xs black" OnClick="lbRefuse_Click" Visible='<%# ( Eval("IsDMAccredit").ToString() == "0") ? true:false %>'><i class="fa fa-trash-o"></i> رفض</asp:LinkButton>
                                    </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
                            <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString='<%$ ConnectionStrings:IsraaHumanResource %>' SelectCommand="GetFilterdDMAttendanceExits" SelectCommandType="StoredProcedure">
                                <SelectParameters>
