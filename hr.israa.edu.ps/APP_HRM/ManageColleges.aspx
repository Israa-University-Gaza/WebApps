<%@ Page Title="" Language="C#" MasterPageFile="~/APP_HRM/MasterPage.master" AutoEventWireup="true" CodeFile="ManageColleges.aspx.cs" Inherits="APP_HRM_ManageColleges" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">إدارة عمداء الكليات</a></li>
    </ul>
</asp:Content>
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th style="width: 2%">#</th>
                                <th style="text-align: center; width: 30%">إسم الكلية</th>
                                <th style="text-align: center; width: 30%">العميد </th>
                                <th style="text-align: center; width: 30%">السكرتير</th>
                        ...
                        <tbody>
                            <asp:ListView ID="ListView1" DataSourceID="SqlDataSource3" OnItemDataBound="ListView1_ItemDataBound" runat="server" >
                                <ItemTemplate>
                                    ...
                                    <td style="text-align: center"><span>
                                       <asp:DropDownList ID="ddlEmployee2" CssClass="select2_category form-control"  DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="ID" runat="server"></asp:DropDownList>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="GetColleges" SelectCommandType="StoredProcedure">
                            </asp:SqlDataSource>
                        </tbody>
                    </table>
