<%@ Page Title="" Language="C#" MasterPageFile="~/APP_HRM/MasterPage.master" AutoEventWireup="true" CodeFile="SickVacationAccrediate.aspx.cs" Inherits="APP_HRM_SickVacationAccrediate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">اعتماد الاجازات المرضية</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                ...
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>إعتماد إجازات الموظفين المرضية</div>
                    <div class="tools">
...
<%--                                        <asp:LinkButton ID="lbDelete" runat="server" class="btn default btn-xs purple" Visible='<%# ( (Eval("IsAccredit").ToString() == "0")) ? true:false %>' OnClick="lbDelete_Click" OnClientClick="return confirm('هل انت متاكد من عملية الحذف؟')"><i class="fa fa-trash-o"></i>  حذف</a></asp:LinkButton>--%>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString='<%$ ConnectionStrings:IsraaHumanResource %>' SelectCommand="GetFilterdSickVacations" SelectCommandType="StoredProcedure">
                                <%--<SelectParameters>
