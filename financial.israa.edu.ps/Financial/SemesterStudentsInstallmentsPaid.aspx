<%@ Page Title="" Language="C#" MasterPageFile="~/Financial/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterStudentsInstallmentsPaid.aspx.cs" Inherits="Financial_SemesterStudentsInstallmentsPaid" %>
                            ...
                            <div style="font-size: 16px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                                <div class="col-xs-12" style="text-align: center">
                                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource2">
                                        <ItemTemplate>
                                            <strong>إجمالي الأقساط المسددة :</strong>
