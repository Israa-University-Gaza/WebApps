<%@ Page Title="" Language="C#" MasterPageFile="~/Financial/MasterPage.master" AutoEventWireup="true" CodeFile="Students.aspx.cs" Inherits="Financial_Students" %>
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <asp:TextBox ID="txtStudentNo" runat="server" class="form-control" placeholder="الرجاء إدخال رقم الطالب للبحث"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <asp:TextBox ID="txtArFirstName" runat="server" class="form-control" placeholder="اسم الطالب"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                            <asp:TextBox ID="txtSecoundName" runat="server" class="form-control" placeholder="اسم الأب"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                            <asp:TextBox ID="txtArThirdName" runat="server" class="form-control" placeholder="اسم الجد"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                            <asp:TextBox ID="txtArFamilyName" runat="server" class="form-control" placeholder="اسم العائلة"></asp:TextBox>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center; width: 15%">اسم الطالب</th>
                                        <th style="text-align: center; width: 10%">الرصيد</th>
                                        <th style="text-align: center; width: 15%">نوع الطالب</th>
                                        <th style="text-align: center; width: 15%">حالة الطالب</th>
                                        <th style="text-align: center; width: 13%">الكلية</th>
                                        <th style="text-align: center; width: 12%">القسم</th>
                                        <th style="text-align: center; width: 10%">المعدل التراكمي</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource4">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><a href="Student.aspx?id=<%# Eval("ID") %>" target="_blank"><%# Eval("StudentName") %></a></td>
                                                <td style="text-align: center;"><a href="StudentFinancialProfile.aspx?id=<%# Eval("ID") %>" target="_blank"><%# Eval("Balance") %></a></td>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:isra %>"
                                        SelectCommand="GetSearchAllStudents" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
