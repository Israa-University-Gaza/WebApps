<%@ Page Title="" Language="C#" MasterPageFile="~/Financial/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterStudentsInstallmentsNotPaid.aspx.cs" Inherits="Financial_SemesterStudentsInstallmentsNotPaid" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#SemesterStudentsInstallmentsNotPaid').addClass("active open");
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        <li>
            ...
            <a href="#" class="font-ha">مالية القبول والتسجيل</a>
            <i class="fa fa-angle-left"></i>
        </li>
        <li><a href="#" class="font-ha">كشف أقساط الطلاب الغير مسددة</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>كشف أقساط الطلاب الغير مسددة</div>
                    <div class="tools">
                            ...
                            <div style="font-size: 16px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                                <div class="col-xs-12" style="text-align: center">
                                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource2">
                                        <ItemTemplate>
                                            <strong>إجمالي الأقساط الغير مسددة :</strong>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        ...
                                        <SelectParameters>
                                            ...
                                            <asp:Parameter Name="IsPaid" DefaultValue="0" Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                            ...
                            <div class="row table-responsive">
                                ...
                                <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                                    <div class="col-xs-11" style="text-align: center">
                                        <strong>لا يوجد أقساط غير مسددة في هذا الفصل الدراسي</strong>
                                        <div style="clear: both"></div>
                                    </div>
