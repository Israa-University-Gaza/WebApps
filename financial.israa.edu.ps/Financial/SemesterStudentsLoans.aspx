<%@ Page Title="" Language="C#" MasterPageFile="~/Financial/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterStudentsLoans.aspx.cs" Inherits="Financial_SemesterStudentsLoans" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#SemesterStudentsLoans').addClass("active open");
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">كشف قروض الطلاب</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>كشف قروض الطلاب</div>
                    <div class="tools">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 20%; text-align: center">قيمة القرض</th>
                                            <th scope="col" style="width: 20%; text-align: center">تاريخ الإستحقاق</th>
                                        </tr>
                                    </thead>
                                    <tbody>
