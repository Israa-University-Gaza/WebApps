<%@ Page Title="" Language="C#" MasterPageFile="~/Financial/MasterPage.master" AutoEventWireup="true" CodeFile="StudentScholarshipFromAccount.aspx.cs" Inherits="Financial_StudentScholarshipFromAccount" %>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource82" runat="server" ConnectionString="<%$ ConnectionStrings:isra3 %>"
                                                SelectCommand="SELECT ID, ArName FROM [Action] WHERE ID=70"></asp:SqlDataSource>
                                        </div>
                                    </div>
                                </div>
                                <br />
