<%@ Page Title="" Language="C#" MasterPageFile="~/Financial/MasterPage.master" AutoEventWireup="true" CodeFile="StudentFromAccount.aspx.cs" Inherits="Financial_StudentFromAccount" %>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <asp:DropDownList ID="ddlAccount" runat="server" CssClass="form-control" DataSourceID="SqlDataSource81" DataTextField="AccountName" DataValueField="ID"></asp:DropDownList>
                                            <asp:SqlDataSource ID="SqlDataSource81" runat="server" ConnectionString="<%$ ConnectionStrings:isra3 %>"
                                                SelectCommand="SELECT ID, AccountName From Account Where IsDelete=0 union select -1,N'إختر الحساب'"></asp:SqlDataSource>
                                        </div>
                                    </div>
                                </div>
                                <br />
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="col-md-2">المبلغ : </label>
                                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-offset-2 col-md-4">
                                            <asp:Button ID="btnAddAccountToStudentTransaction" runat="server" CssClass="btn blue btn btn-rounded default" OnClick="AddAccountToStudentTransaction_Click" Text="تحويل المبلغ" />
                                        </div>
                                    </div>
                                </div>
                            </div>
