<%@ Page Title="" Language="C#" MasterPageFile="~/Financial/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterStudentsScholarship.aspx.cs" Inherits="Financial_SemesterStudentsLoans" %>
                    ...
                    <div class="form-horizontal">
                        <div class="form-body" style="width: 65%; margin: 0 auto;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <asp:DropDownList ID="ddlAction" runat="server" class="form-control" DataSourceID="SqlDataSource2" DataTextField="ArName" DataValueField="ID" AutoPostBack="true"></asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:isra3 %>"
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 10%; text-align: center">المنحة</th>
                                            <th scope="col" style="width: 10%; text-align: center">قيمة المنحة</th>
                                            <th scope="col" style="width: 15%; text-align: center">تاريخ الإعتماد</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource3">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><a href="StudentScholarship.aspx?id=<%# Eval("StudentID") %>" target="_blank"><%# Eval("ActionValue") %></span></td>
                                                    <td style="text-align: center"><a href="StudentFinancialProfile.aspx?id=<%# Eval("StudentID") %>" target="_blank"><span><%# Eval("ScholarshipValue") %></span></td>
