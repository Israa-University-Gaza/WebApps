...
var OxO77e9=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO77e9[1],true)[OxO77e9[0]]=function (){if(event[OxO77e9[2]]){alert(element[OxO77e9[3]].cssText);} ;} ;
</script>
