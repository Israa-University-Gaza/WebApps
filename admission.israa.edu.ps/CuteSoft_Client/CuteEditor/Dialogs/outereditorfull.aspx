...
var OxO23df=["postback","Save"];function doClose(){Window_SetDialogReturnValue(window,null);var OxOd00a=[];Window_CloseDialog(window);} ;function CuteEditor_OnCommand(editor,Ox4d,Ox4e,Ox4f){if(Ox4d.toLowerCase()==OxO23df[0]&&Ox4f==OxO23df[1]){Window_SetDialogReturnValue(window,'<%= Request.QueryString["f"]%>');} ;} ;
</script>

<asp:Panel runat=server Visible=false id="savedpanel">
<script language="JavaScript" type="text/javascript" >
var OxOd00a=[];Window_CloseDialog(window);
</script>
</asp:Panel>