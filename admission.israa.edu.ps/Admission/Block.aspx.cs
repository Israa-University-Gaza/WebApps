...
public partial class Admission_Block : UserPage
{
    ...
    protected void lbPDF_Click(object sender, EventArgs e)
    {
        ...
        a2.Add(DataAccess.GetStudyTableExamTableReport(DepartmentID, StudyLevelID, GenderID));

        CreatePDF("StudyTableReport", @"Admission\Reports\StudyTableReport.rdlc", a1, a2);
    }
