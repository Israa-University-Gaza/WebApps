<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="StudentTest.aspx.cs" Inherits="Admission_Student" %>
                                            ...
                                            <div class="col-md-8 profile-info">
                                                ...
                                                <div class="portlet box blue">
                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <% if (lblEmployeeID.Text != "5301" && (lblStdStatusID.Text == "1" || lblStdStatusID.Text == "2" || lblStdStatusID.Text == "7" || lblStdStatusID.Text == "12"))
                                                            { %>
                                                    ...
                                                    <div class="portlet-body">
                                                        <ul class="list-unstyled">
                                                            ...
                                                            <% if (lblStdStatusID.Text == "1" || lblStdStatusID.Text == "7")
                                                                { %>
                                                            <li>
                                                                <asp:LinkButton ID="lbAddReoprtCost2" runat="server" class="btn default btn-sm blue-stripe isra-inline-1 font-ha" OnClick="lbAddReoprtCost2_Click" OnClientClick="return confirm('هل انت متاكد من أنك تود فرض رسوم طلب جدول دراسي بعد المرة الأولى؟')">فرض رسوم طلب جدول دراسي بعد المرة الأولى</asp:LinkButton>
                                                            </li>
                                                            <% } %>
                                                            <% if (lblStdStatusID.Text == "1" || lblStdStatusID.Text == "2" || lblStdStatusID.Text == "7" || lblStdStatusID.Text == "12")
                                                                { %>
                                                    ...
                                                    <asp:Repeater ID="Repeater4" runat="server">
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center"><span><%# (Convert.ToBoolean(Eval("IsMidtermIncomplete").ToString())) ? "غير مكتمل": ((Convert.ToBoolean(Eval("IsMidtermNoMark").ToString())) ? "غياب" : ((Convert.ToBoolean(Eval("IsTotalZero").ToString()))) ? "صفر في العلامة الكلية":  Eval("MidtermMark")) %></span></td>
                                                                <td style="text-align: center"><span><%# (((Convert.ToBoolean(Eval("IsTotalZero").ToString()))) ? "صفر في العلامة الكلية":Eval("FinalMark")) %></span></td>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource33" runat="server"
                                                        ConnectionString="<%$ ConnectionStrings:isra %>"
                                                        SelectCommand="GetStdSemesterStatistic_New" SelectCommandType="StoredProcedure">
                                                        <SelectParameters>
                                                            <asp:ControlParameter ControlID="ddlSemester_3" PropertyName="SelectedValue" Name="StdSemesterID" Type="Int32" />
                                                        </SelectParameters>
                                                    </asp:SqlDataSource>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" style="padding-top: 15px;">
                                                    <div class="col-md-offset-2 col-md-6">
                                                        <asp:Button ID="btnRegisterBlock" runat="server" Text="تسجيل مساقات المستوى" CssClass="btn green" OnClick="btnRegisterBlock_Click" />
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="row">
