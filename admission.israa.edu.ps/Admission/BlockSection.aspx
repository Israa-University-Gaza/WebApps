<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="BlockSection.aspx.cs" Inherits="Admission_BlockSection" %>
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <asp:DropDownList ID="ddlBlocks" runat="server" class="select2_category form-control" DataSourceID="SqlDataSource5" DataTextField="Name" DataValueField="ID" AutoPostBack="true"></asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT ID, Name FROM [Block] WHERE ([IsActive] = 1) AND ([IsDelete] = 0)"></asp:SqlDataSource>
                            </div>
                            <div class="col-md-4">
                                <asp:LinkButton ID="lbBlockSectionPdf" runat="server" OnClick="lbBlockSectionPdf_Click">pdf</asp:LinkButton></div>
                        </div>
                    </div>
                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <asp:DropDownList ID="ddlBlock" runat="server" class="select2_category form-control" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="ID"></asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT ID, Name FROM [Block] WHERE ([IsActive] = 1) AND ([IsDelete] = 0)"></asp:SqlDataSource>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT ID, (Select ArName From Course Where ID=CourseID) as CourseArName FROM [OfferdCourse] WHERE (SemesterID=3) AND ([IsDelete] = 0)"></asp:SqlDataSource>
                                </div>
                            </div>
                            <div class="form-group">
