<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="AdmissionIssueShow.aspx.cs" Inherits="Admission_AdmissionIssueShow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="AdmissionIsuueShow.aspx" class="font-ha">قضايا الطلاب 
        </a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <asp:DropDownList ID="ddlProgram" runat="server" CssClass="select2_category form-control" DataSourceID="SqlDataSource4" DataTextField="ArName" DataValueField="ID" AutoPostBack="true" OnSelectedIndexChanged="ddlProgram_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-md-2">
                            <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="select2_category form-control" DataSourceID="SqlDataSource5" DataTextField="ArName" DataValueField="ID" AutoPostBack="true" OnSelectedIndexChanged="DataBind_Click"></asp:DropDownList>
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i>عرض قضايا الطلاب المتوقفة عند القبول والتسجيل
                </div>
                <div class="tools">
                    <a href="" class="collapse"></a>
                    <a href="" class="remove"></a>
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%; text-align: center;">رقم واسم الطالب</th>
                                <th style="width: 20%; text-align: center;">كلية وقسم الطالب</th>
                        ...
                        <tbody>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <asp:LinkButton ID="lbGoStudent" runat="server" OnClick="lbGoStudent_Click"><%# Eval("StudentNo")   %> <br /> <%# Eval("StudentName")   %>  </asp:LinkButton></td>
                                        <td style="text-align: center"><%# Eval("StudentCollege") %><br />
                                            <%# Eval("StudentDepartment") %></td>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:IsraaStudentIssue %>' SelectCommand="IssuesShow" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="-1" Name="EmployeeID" Type="Int32"></asp:Parameter>
                                    <asp:Parameter DefaultValue="4" Name="Place" Type="Int32"></asp:Parameter>
