<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="MidtermExamStudentStatistics.aspx.cs" Inherits="Admission_MidtermExamStudentStatistics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#MidtermExamDetails').addClass("active open");
        });
    </script>
</asp:Content>
                        ...
                        <table class="table table-striped table-hover" id="sample_editable_1 ">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 30%; text-align: center;">اليوم</th>
                                    <th style="width: 10%; text-align: center;">الفترة</th>
                                    <th style="width: 20%; text-align: center;">المحافظة</th>
                            ...
                            <tbody>
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:isra %>" ProviderName="System.Data.SqlClient" SelectCommand="GetMidtermExamStudentStatistics" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
