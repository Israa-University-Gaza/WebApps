<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="StudentsCourses.aspx.cs" Inherits="Admission_StudentsCourses" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#StudentsCourses').addClass("active open");
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="StudentsCourses.aspx" class="font-ha">طبات تسجيل الطلاب 
        </a></li>
    </ul>
</asp:Content>
    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i>عرض طلبات تسجيل الطلاب
                </div>
            </div>
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 25%; text-align: center">عدد الطلبات</th>
                                <th style="width: 25%; text-align: center">اجمالي عدد الساعات</th>
                                <th style="width: 25%; text-align: center">تاريخ التسجيل</th>
                                <th style="width: 25%; text-align: center">ساعات التسجيل الفعلية</th>
                            </tr>
                        </thead>
                        <tbody>
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="text-align: center"><span><%# Eval("RequestCount") %></span></td>
                                        <td style="text-align: center"><span><%# Eval("TotalCourseHours") %></span></td>
                                        <td></td>
                                        <td style="text-align: center"><span><%# Eval("semesterRegisteredHours") %></span></td>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="GetStudentsCourses" SelectCommandType="StoredProcedure">
                                <SelectParameters>
