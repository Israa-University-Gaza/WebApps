<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="AcceptStudentCondition1.aspx.cs" Inherits="Admission_AcceptStudentCondition1" %>
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">نوع طلب الالتحاق </label>
                                    <div class="col-md-4">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                            ...
                                            SelectCommand="ShowStudentApplication1Get" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
