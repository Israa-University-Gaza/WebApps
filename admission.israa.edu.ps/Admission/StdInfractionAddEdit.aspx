<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="StdInfractionAddEdit.aspx.cs" Inherits="StdInfractionAddEdit" %>
<%@ Register TagPrefix="uc1" TagName="StudentSideBar" Src="~/Admission/UserControls/StudentSideBar.ascx" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            ...
            <uc1:StudentSideBar runat="server" ID="StudentSideBar" ActiveTab="li6" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:isra %>' SelectCommand="GetInfraction" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
