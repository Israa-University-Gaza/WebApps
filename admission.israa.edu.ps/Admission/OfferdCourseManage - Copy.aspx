<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="OfferdCourseManage - Copy.aspx.cs" Inherits="Admission_OfferdCourseManage" %>
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="Select ID, ArName From Program Where IsActive=1 and IsDelete=0"></asp:SqlDataSource>
                        </div>
                        <label class="control-label col-md-1">الفصل الدراسي</label>
                        <div class="col-md-3">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT top 3 ID, ArName FROM [Semester] ORDER BY ID DESC"></asp:SqlDataSource>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="Select ID, ArName From College Where ProgramID=@ProgramID and IsActive=1 and IsDelete=0">
                                <SelectParameters>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="Select ID, ArName From Department Where CollegeID=@CollegeID and IsActive=1 and IsDelete=0">
                                <SelectParameters>
                    ...
                    <div class="row">
                        <div class="col-md-offset-1 col-md-3">
                            <asp:Button ID="btnView" runat="server" Text="عرض" class="btn green" OnClick="btnView_Click1" />
                        </div>
                    </div>
                    <br />
                    <div class="row">
                            ...
                            <table class="table table-condensed table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center; width: 10%; border-top: none!important; font-size: 12px;">البرنامج </th>
                                        <th style="text-align: center; width: 10%; border-top: none!important; font-size: 12px;">القسم</th>
