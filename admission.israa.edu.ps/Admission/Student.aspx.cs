...
public partial class Admission_Student : UserPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                var stdlvl = DT2.Rows[0]["StudentlevelID"].ToString();
                var RegisterSemesterID = DT2.Rows[0]["RegisterSemesterID"].ToString();
                if (stdlvl == "1" && RegisterSemesterID == "12")
                {
                    div_lvl1.Visible = true;
                }
                else
                {
                    div_notlvl1.Visible = true;
                }
                DataTable tblDesire = DataAccess.ddlPlaceOfStudies();

                ddlPlaceOfStudies.DataSource = tblDesire;
                ddlPlaceOfStudies.SelectedValue = DT2.Rows[0]["PlaceOfStudyID"].ToString();
                ddlPlaceOfStudies.DataBind();
    ...
    protected void btnRegisterBlock_Click(object sender, EventArgs e)
    {
        ...
        DataTable DT = DataAccess.RegisterBlockCourses1(lblStudentID.Text, EmployeeID, ddlPlaceOfStudies.SelectedValue);
        DataTable DA = DataAccess.PlaceOfStudyEdit(lblStudentID.Text, ddlPlaceOfStudies.SelectedValue);
    ...
    protected void btnChangeStudentStatus_Click(object sender, EventArgs e)
    {
        ...
        {
            DataTable DT = DataAccess.ChangeStudentStatus(lblStudentID.Text, ddlSemester.SelectedValue, ddlStudentStatus.SelectedValue, txtChangeStatusNote.Text, EmployeeID);
    ...
    protected void lbFinalMarkIncompleteAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Admission/Student.aspx?id=" + lblStudentID.Text + "&tab=5");
    }
    ...
    protected void btnWithdrawCourse_Click(object sender, EventArgs e)
    {
        ...
        DataTable DA = DataAccess.StudentBranchAddEdit(lblStudentID.Text, 12);
        ShowMsg21(DT.Rows[0]["msg"].ToString(), (Convert.ToInt32(DT.Rows[0]["status"].ToString()) > 0) ? "success" : "danger");
        Repeater15.DataSource = dt;
        Repeater15.DataBind();
        OpenTab(21);
        string stdSemesterId = ddlStdSemester21.SelectedValue;
        string a = "https://system.israa.edu.ps/app/AllCalculatOfStdSemester?stdSemesterId=" + stdSemesterId + "&IsReg=false&accreditationStatusEnum=1";
        ExcuteApI(a);
    }
    ...
    protected void LinkButton3_OnClick(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(ddlStdSemester1.SelectedValue))
        {
            OpenTab(3);
    ...
    protected void LinkButton5_OnClick(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(ddlStdSemester2.SelectedValue))
        {
            Repeater4.DataSource = DataAccess.GetStdSemesterMarks(Convert.ToInt32(ddlStdSemester2.SelectedValue));
            Repeater4.DataBind();
        }
    ...
    protected void LinkButton22_OnClick(object sender, EventArgs e)
    {
        ...
        //if (!String.IsNullOrEmpty(ddlSemester_3.SelectedValue))
        //{
        //    DataTable dt = DataAccess.GetStdSemesterMarksBItrans(Convert.ToInt32(ddlSemester_3.SelectedValue));
        //    Repeater18.DataSource = dt;
        //    Repeater18.DataBind();
    ...
    protected void LinkButton21_OnClick(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(ddlStdSemester21.SelectedValue))
        {
    ...
    protected void Repeater9_OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        var Repeater4 = (Repeater)e.Item.FindControl("Repeater44");
    ...
    protected void btnRegisterBlockBranch1_Click(object sender, EventArgs e)
    {
    ...
    protected void btnRegisterBlockBranch2_Click(object sender, EventArgs e)
    {
        DataTable DT = DataAccess.RegisterBlockCourses(lblStudentID.Text, EmployeeID, "2");
        ShowMsg8(DT.Rows[0]["msg"].ToString(), (Convert.ToInt32(DT.Rows[0]["status"].ToString()) > 0) ? "success" : "danger");
        OpenTab(8);
        Repeater1.DataBind();
        Repeater2.DataBind();
    ...
    protected void IsMidtermNoMarkAccept_Click(object sender, EventArgs e)
    {
        RepeaterItem item = (RepeaterItem)((LinkButton)sender).Parent;
        string StdSectionID = ((Label)item.FindControl("StdSectionID")).Text;
        DataTable DT = DataAccess.SetMarkMidtermNoMarkAccept(StdSectionID, EmployeeID);
        ShowMsg5("تم تقديم العذر النصفي بنجاح", (DT.Rows[0]["status"].ToString() != "0") ? "success" : "danger");
        Repeater4.DataSource = DataAccess.GetStdSemesterMarks(Convert.ToInt32(ddlStdSemester2.SelectedValue));
        Repeater4.DataBind();
        OpenTab(5);
    }

    protected void lbAddFinancialGeneralBenefitCost_Click(object sender, EventArgs e)
    {
        DataTable DT = DataAccess.AddStudentReportCost(lblStudentID.Text, "113", EmployeeID);
        ShowToast(this, DT.Rows[0]["msg"].ToString(), "", (Convert.ToInt32(DT.Rows[0]["status"].ToString()) > 0) ? "success" : "error");
        Repeater10.DataBind();
    }

  protected void lbStudentInternalTransformationPDF_Click(object sender, EventArgs e)
    {
        ArrayList a1 = new ArrayList();
        a1.Add("dsStudentInternalTransformationAPI");

        ArrayList a2 = new ArrayList();
        a2.Add(ToDataTable(DataAccess.ListviewResult(lblStudentID.Text, true,"").ToList()));

        CreatePDF("StudentInternalTransformation_", @"Admission\Reports\StudentInternalTransformationReport.rdlc", a1, a2);

    }

    protected void lbStudentRichnessCoursesPDF_Click(object sender, EventArgs e)
    {
        ...
        ArrayList a2 = new ArrayList();
        a2.Add(ToDataTable(DataAccess.ListviewResult(lblStudentID.Text, false,"").ToList()));

        CreatePDF("StudentRichnessCourses_", @"Admission\Reports\StudentRichnessCoursesReport.rdlc", a1, a2);
    }

    protected void lbIsMidtermUnIncomplete_Click(object sender, EventArgs e)
    {
        RepeaterItem item = (RepeaterItem)((LinkButton)sender).Parent;
        string StdSectionID = ((Label)item.FindControl("StdSectionID")).Text;
        DataTable DT = DataAccess.SetMarkMidtermUnIncomplete(StdSectionID);
        ShowMsg5(DT.Rows[0]["msg"].ToString(), (DT.Rows[0]["status"].ToString() != "0") ? "success" : "danger");
        if (DT.Rows[0]["status"].ToString() != "0")
        {
    ...
    protected void lbFinalMarkUnIncomplete_OnClick(object sender, EventArgs e)
    {
        RepeaterItem item = (RepeaterItem)((LinkButton)sender).Parent;
        string StdSectionID = ((Label)item.FindControl("StdSectionID")).Text;
        DataTable DT = DataAccess.SetMarkFinalUnIncomplete(StdSectionID,EmployeeID);
        ShowMsg5(DT.Rows[0]["msg"].ToString(), (DT.Rows[0]["status"].ToString() != "0") ? "success" : "danger");
        if (DT.Rows[0]["status"].ToString() != "0")
        {
    ...
    protected void AddTransactionCost129_OnClick(object sender, EventArgs e)
    {
        DataTable DT = DataAccess.AddTransactionCost(lblStudentID.Text, "138", EmployeeID);
        ShowToast(this, DT.Rows[0]["msg"].ToString(), "", (Convert.ToInt32(DT.Rows[0]["status"].ToString()) > 0) ? "success" : "error");
        var studentid = Convert.ToInt32(lblStudentID.Text);
        DataTable dt = DataAccess.GetStudentInfo(studentid);
        GetStudentAcademicWarningOutPut da = DataAccess.GetStudentAcademicWarning(lblStudentID.Text);
	    ...
	    protected void AddTransactionCost130_OnClick(object sender, EventArgs e)
    {
        DataTable DT = DataAccess.AddTransactionCost(lblStudentID.Text, "130", EmployeeID);
        ShowToast(this, DT.Rows[0]["msg"].ToString(), "", (Convert.ToInt32(DT.Rows[0]["status"].ToString()) > 0) ? "success" : "error");
        var studentid = Convert.ToInt32(lblStudentID.Text);
        DataTable dt = DataAccess.GetStudentInfo(studentid);
        GetStudentAcademicWarningOutPut da = DataAccess.GetStudentAcademicWarning(lblStudentID.Text);
    ...
    protected void lbStudentBankPay_Click(object sender, EventArgs e)
    {
        ArrayList a1 = new ArrayList();
        a1.Add("dsGetStudentData");

        ArrayList a2 = new ArrayList();
        a2.Add(DataAccess.GetStudentData(lblStudentID.Text));

        CreatePDF("StudentBankPay", @"Admission\Reports\studentBankPay.rdlc", a1, a2);
