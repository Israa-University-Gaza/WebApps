<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="ShowAdmissionApplication.aspx.cs" Inherits="Admission_ShowAdmissionApplication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#ShowAdmissionApplication_1 a').css("background-color", "#575757");
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                            ...
                                            SelectCommand="ShowAdmissionApplicationGet" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
