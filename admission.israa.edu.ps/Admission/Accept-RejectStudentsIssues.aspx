<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="Accept-RejectStudentsIssues.aspx.cs" Inherits="Admission_Accept_RejectStudentsIssues" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="AdmissionIssueShow.aspx" class="font-ha">قضايا الطالب
        </a></li>
    </ul>
</asp:Content>
                ...
                <div class="form-body">
                    ...
                    <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                        <div class="col-xs-11" style="text-align: center">
                            <strong>لا يوجد أي إجراء إداري مسبق للقضية</strong>
