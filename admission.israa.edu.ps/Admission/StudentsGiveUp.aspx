<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="StudentsGiveUp.aspx.cs" Inherits="Admission_StudentsGiveUp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#Student_StudentsGiveUp a').css("background-color", "#575757");
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>الطلاب المنسحبين</div>
                    <div class="tools">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                        ...
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="6" Name="StudentStatusID" Type="Int32" />
