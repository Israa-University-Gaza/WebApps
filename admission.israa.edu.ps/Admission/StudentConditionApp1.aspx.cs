...
public partial class Admission_StudentConditionApp1 : UserPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["StdID"] != null)
            {
                ...
                Response.Redirect("~/Admission/StudentConditionApp.aspx");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            //DataTable dt = DataAccess.StudentTawjehyDataGet(lblStudentID.Text);
            //if (Convert.ToInt32(dt.Rows[0]["TawjehyGPA"]) >= 70)
            //{
            DataTable DT = DataAccess.AccreditStudent(lblStudentID.Text, ddlDepartment.SelectedValue, EmployeeID);
        ...
        {
            ShowMsg5("يجب اختيار القسم", "danger");
        }
        RunJQuery();
        ...
        //    if (Convert.ToInt32(DT.Rows[0]["status"].ToString()) > 0)
        //    {
        //        //bool SendOk = SendSMS(DT.Rows[0]["jawwal"].ToString(), DT.Rows[0]["smstext"].ToString());
        //       // ShowMsg5(DT.Rows[0]["msg"].ToString() + (SendOk ? " وتم إرسال الرسالة بنجاح" : " ولم يتم إرسال الرسالة"), "success");
        //        ShowMsg5(DT.Rows[0]["msg"].ToString() , "success");
        //    }
        //    else
        //    {
        //        ShowMsg5(DT.Rows[0]["msg"].ToString(), "danger");
        //    }
        //}
        //else
        //{
