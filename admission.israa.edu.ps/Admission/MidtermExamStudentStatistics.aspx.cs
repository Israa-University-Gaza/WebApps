...
public partial class Admission_MidtermExamStudentStatistics : UserPage
{
    ...
    protected void lbExcel_Click(object sender, EventArgs e)
    {
        ...
        DataTable DT = DataAccess.GetMidtermExamStudentStatistics(ddlSemester.SelectedValue, ddlExamDate.SelectedValue, ddlExamTime.SelectedValue, ddlBranch.SelectedValue, ddlGovernorates.SelectedValue);
        ExportToExcel(DT);
    }
    ...
    public void ExportToExcel(DataTable dt)
    {
        if (dt.Rows.Count > 0)
        {
            string filename = "MidtermExamStudentStatistics1.xls";
    ...
    {
        DataTable DT = DataAccess.GetMidtermExamStudentStatistics1(ddlSemester.SelectedValue, ddlExamDate.SelectedValue, ddlExamTime.SelectedValue, ddlBranch.SelectedValue, ddlGovernorates.SelectedValue);
        ExportToExcel(DT);
    }
}
