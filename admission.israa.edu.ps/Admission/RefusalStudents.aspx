<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="RefusalStudents.aspx.cs" Inherits="Admission_RefusalStudents" %>
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>الطلاب المرفوضين</div>
                    <div class="tools">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center; width: 11%">إسم الطالب</th>
                                        <th style="text-align: center; width: 14%">نوع الطالب</th>
                                        <th style="text-align: center; width: 13%">القسم</th>
                                        <th style="text-align: center; width: 33%">سبب الرفض</th>
                                ...
                                <tbody>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <asp:LinkButton ID="lbAcceptRefuseStudent" runat="server" class="btn default btn-xs black" OnClick="lbAcceptRefuseStudent_Click" OnClientClick="return confirm('هل أنت متأكد من قبول رفض الطالب');">قبول الرفض</asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:ListView>
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                        ...
                                        SelectCommand="GetRefusalStudents" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                </tbody>
                            </table>
                            ...
                            <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                                <div class="col-xs-11" style="text-align: center">
                                    <strong>لا يوجد طلاب مرفوضين</strong>
