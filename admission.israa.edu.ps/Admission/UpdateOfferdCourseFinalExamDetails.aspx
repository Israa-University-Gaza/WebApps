<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateOfferdCourseFinalExamDetails.aspx.cs" Inherits="Admission_UpdateOfferdCourseFinalExamDetails" %>
                    ...
                    <div class="form-body">
                        ...
                        <table class="table table-striped table-hover" id="sample_editable_1 ">
                            ...
                            <tbody>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <asp:CheckBox ID="cbFinalExam" runat="server" Checked='<%# Eval("IsFinalExam") %>' /></td>
                                            <td style="text-align: center">
                                                <asp:CheckBox ID="cbFinalEExam" runat="server" Checked='<%# Eval("IsFinalEExam") %>' /></td>
                                            <td style="text-align: center">
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:isra %>" ProviderName="System.Data.SqlClient" SelectCommand="GetOfferdCourseFinalExamDetails" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
