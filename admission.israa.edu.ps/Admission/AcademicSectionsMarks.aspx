<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicSectionsMarks.aspx.cs" Inherits="Academic_AcademicSectionsMarks" %>
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    ...
                    <% if (ListView1.Items.Count > 0)
                        { %>
                    <div class="form-group row">
                        <asp:Button ID="BtnSaveAll" runat="server" CssClass="btn green" Text="اعتماد الشعب كعميد" OnClick="BtnSaveAll_Click" />
                        <asp:Button ID="BtnSaveAll1" runat="server" CssClass="btn green" Text="اعتماد الشعب كنائب أكاديمي" OnClick="BtnSaveAll1_Click" />
                    </div>
