<%@ Page Title="" Language="C#" MasterPageFile="~/Admission/MasterPage.master" AutoEventWireup="true" CodeFile="AcceptAdmissionApplication1.aspx.cs" Inherits="Admission_AcceptAdmissionApplication1" %>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                            ConnectionString="<%$ ConnectionStrings:isra %>"
                                            SelectCommand="GetAdmissionApplication1" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
