<%@ WebHandler Language="C#" Class="GetBlockLectures" %>
...
public class GetBlockLectures : IHttpHandler
{

    public void ProcessRequest(HttpContext context)
    {
        System.Web.Script.Serialization.JavaScriptSerializer oSerializer = new System.Web.Script.Serialization.JavaScriptSerializer();
        string sJSON = oSerializer.Serialize(GetMyEvents(context.Request.QueryString["blockid"]));
    ...
    public List<Event> GetMyEvents(string blockid)
    {
        List<Event> events = new List<Event>();
        DataTable DT = DataAccess.GetBlockLectures(blockid);
