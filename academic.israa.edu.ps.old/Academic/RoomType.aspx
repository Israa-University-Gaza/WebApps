<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="RoomType.aspx.cs" Inherits="Academic_RoomType" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="row">
        <% if (Permissions.Contains("RoomTypeView"))
           { %>
        <div class="col-md-7">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>أنواع القاعات</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th style="width: 40%">نوع القاعة</th>
                        ...
                        <tbody>
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                                <ItemTemplate>
                                    ...
                                    <tr <%# (lblRoomTypeID.Text==Eval("ID").ToString())?"style='background-color:#F5F5F5'":"" %>>
                                        <td><span><%# Eval("Name") %></span></td>
                                        <td style="text-align: center">
                                            <asp:CheckBox ID="cbIsActive" runat="server" AutoPostBack="true" OnCheckedChanged="cbIsActive_CheckedChanged" Checked='<%# Eval("IsActive") %>' Enabled='<%# (Permissions.Contains("RoomTypeActivate"))? true:false %>' />
                                        </td>
                                        <td style="text-align: center">
                                            <% if (Permissions.Contains("RoomTypeEdit"))
                                               { %>
                                            ...
                                            <% } %>
                                            <% if (Permissions.Contains("RoomTypeDelete"))
                                               { %>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="SELECT * FROM [RoomType] where [IsDelete]=0 order by [ID]"></asp:SqlDataSource>
                        </tbody>
                    </table>
                    ...
                    <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                        <div class="col-xs-11" style="text-align: center">
                            <strong>لم يتم إضافة أنواع قاعات دراسية بعد</strong>
        ...
        <% } %>
        <% if (Permissions.Contains("RoomTypeAdd") || Permissions.Contains("RoomTypeEdit"))
           { %>
        <div class="col-md-5">
            <div class="portlet box blue">
                <asp:Label ID="lblRoomTypeID" runat="server" Text="" Visible="false"></asp:Label>
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>إضافة/تعديل نوع القاعة</div>
                    <div class="tools">
                        <a class="collapse" href="javascript:;"></a>
                    </div>
                </div>
                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">نوع القاعة</label>
                                <div class="col-md-9">
                                    <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="الرجاء ادخال نوع القاعة"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
