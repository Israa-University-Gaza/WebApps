<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="College.aspx.cs" Inherits="Academic_College" %>
    ...
    <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li>
            <button data-close-others="true" data-delay="1000" data-hover="dropdown" data-toggle="dropdown" class="btn font-ha dropdown-toggle" style="padding: 0px!important; background-color: #FAFAFA!important;" type="button">
                <span>الكليات</span> <i class="fa fa-angle-down"></i>
            </button>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="row">
        <% if (Permissions.Contains("CollegeView"))
           { %>
        <div class="col-md-7">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%; text-align: center">معدل القبول1</th>
                                 <th style="width: 20%; text-align: center">معدل القبول2</th>
                        ...
                        <tbody>
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                                <ItemTemplate>
                                    ...
                                    <tr <%# (lblCollegeID.Text==Eval("ID").ToString())?"style='background-color:#F5F5F5'":"" %>>
                                        <td><span><%# Eval("CollegeNum") %></span></td>
                                        <td><span><%# Eval("ArName") %></span></td>
                                        <td><span><%# Eval("Program") %></span></td>
                                        <td style="text-align: center"><span><%# Eval("AcceptanceRate1") %></span></td>
                                         <td style="text-align: center"><span><%# Eval("AcceptanceRate2") %></span></td>
                                        <td style="text-align: center">
                                            <asp:CheckBox ID="cbIsActive" runat="server" AutoPostBack="true" OnCheckedChanged="cbIsActive_CheckedChanged" Checked='<%# Eval("IsActive") %>' Enabled='<%# (Permissions.Contains("CollegeActivate"))? true:false %>' /></td>
                                        <td style="text-align: center">
                                            <% if (Permissions.Contains("CollegeEdit"))
                                               { %>
                                            ...
                                            <% } %>
                                            <% if (Permissions.Contains("CollegeDelete"))
                                               { %>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="SELECT *,(Select ArName From [Program] Where ID=ProgramID) as Program FROM [College] where [IsLast]=1 and [IsDelete]=0 order by [CollegeNum]"></asp:SqlDataSource>
                        </tbody>
                    </table>
                    ...
                    <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                        <div class="col-xs-11" style="text-align: center">
                            <strong>لم يتم إضافة كليات بعد</strong>
        ...
        <% } %>
        <% if (Permissions.Contains("CollegeAdd") || Permissions.Contains("CollegeEdit"))
           { %>
        <div class="col-md-5">
            <div class="portlet box blue">
                <asp:Label ID="lblCollegeID" runat="server" Text="" Visible="false"></asp:Label>
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>إضافة/تعديل كلية</div>
                    <div class="tools">
                        <a class="collapse" href="javascript:;"></a>
                    </div>
                </div>
                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-4 control-label">رقم الكلية</label>
                                <div class="col-md-8">
                                    <asp:TextBox ID="txtCollegeNum" runat="server" CssClass="form-control numeric" placeholder="الرجاء ادخال رقم الكلية"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">الكلية بالعربي</label>
                                <div class="col-md-8">
                                    <asp:TextBox ID="txtArName" runat="server" CssClass="form-control" placeholder="الرجاء ادخال اسم الكلية بالعربي"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">الكلية بالإنجليزي</label>
                                <div class="col-md-8">
                                    <asp:TextBox ID="txtEnName" runat="server" CssClass="form-control" placeholder="الرجاء ادخال اسم الكلية بالإنجليزي"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">البرنامج</label>
                                <div class="col-md-8">
                                    <asp:DropDownList ID="ddlProgramID" runat="server" DataSourceID="SqlDataSource2" DataTextField="ArName" DataValueField="ID" CssClass="select2_category form-control"></asp:DropDownList>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">عميد الكلية</label>
                                <div class="col-md-8">
                                 ...
                                 <div class="form-group">
                                <label class="col-md-4 control-label">نائب العميد </label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">معدل القبول1</label>
                                <div class="col-md-8">
                              ...
                              <div class="form-group">
                                <label class="col-md-4 control-label">معدل القبول2</label>
                                <div class="col-md-8">
