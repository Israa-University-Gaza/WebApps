...
public partial class Academic_AcademicCourse : UserPage
{
    ...
    {
        bool IntValidate = IntValidateControls(new WebControl[] { ddlCollege, ddlDepartment, ddlCCourseType, ddlCourseType, txtNumOfHours });
        bool Validate = ValidateControls(new WebControl[] { ddlCollege, ddlDepartment, ddlCCourseType, ddlCourseType, txtArName, txtCourseCode, txtEnName, txtNumOfHours });
        if (Validate && IntValidate)
        {
                                      //CourseAddEdit(string ID       , string CourseCode , string ArName , string EnName , string CourseFID, string DepartmentID        , string LevelID , string SemesterID, string CCourseTypeID       , string CourseType          , string NumOfHours , string RequestedFHours, bool IsScholarship, bool IsHaveLab   , bool IsHaveDiscussion   , bool IsActive        , string PreReqID            , string EmployeeID)
