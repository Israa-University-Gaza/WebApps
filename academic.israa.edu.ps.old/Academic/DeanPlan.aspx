<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="DeanPlan.aspx.cs" Inherits="Academic_DeanPlan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#DeanPlan').addClass("active open");
            $('#DeanPlan_1 a').css("background-color", "#575757");
            $('#DeanPlan a span.arrow').addClass("open");
        });
    </script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="row">
            ...
            <div class="portlet box red">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th style="width: 15%">رقم الخطة</th>
                                <th style="width: 30%; text-align: center">التخصص</th>
                                <th style="width: 15%; text-align: center">سنة الإدراج</th>
                        ...
                        <tbody>
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <% if (Permissions.Contains("DeanPlanAccreditation"))
                                               { %>
                                            <asp:LinkButton ID="lbAccrediation" runat="server" CssClass="btn default btn-xs black" OnClick="lbAccrediation_Click" Visible='<%# (Eval("DeanAccreditation").ToString() != "True")%>'><i class="fa fa-edit"></i> إعتماد</asp:LinkButton>
                                            <% } %>
                                        </td>
                                        <td style="text-align: center">
                                            ...
                                            <asp:LinkButton ID="lbEdit" runat="server" CssClass="btn default btn-xs black" OnClick="lbEdit_Click" Visible='<%# (Permissions.Contains("DeanPlanEdit")) %>'><i class="fa fa-edit" ></i></asp:LinkButton>
                                            <asp:LinkButton ID="lbDelete" runat="server" CssClass="btn default btn-xs purple" OnClick="lbDelete_Click" OnClientClick="return confirm('هل انت متاكد من عملية الحذف؟')" Visible='<%# (Permissions.Contains("DeanPlanDelete")) %>'><i class="fa fa-trash-o"></i></a></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="GetDeanPlans" SelectCommandType="StoredProcedure">
                                <SelectParameters>
        ...
        <% if (Permissions.Contains("DeanPlanAdd") || Permissions.Contains("DeanPlanEdit"))
           { %>
        <div class="col-md-5">
                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlDepartmentID" runat="server" CssClass="select2_category form-control" DataSourceID="SqlDataSource2" DataTextField="ArName" DataValueField="ID"></asp:DropDownList>
