<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="IssuesSearch.aspx.cs" Inherits="Academic_IssuesSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#StudentIssue_1 a').css("background-color", "#575757");
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <div class="form-group row">
                     ...
                     <asp:ListItem Value="16">محول من الكلية</asp:ListItem>
                            </asp:DropDownList>
                        </div>
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        <thead>
                            <tr>
                                <th style="width: 10%;">تاريخ القضية</th>
                                <th style="width: 20%; text-align: center;">اسم الطالب</th>
                                <th style="width: 25%; text-align: center;">القضية</th>
                                <th style="width: 20%; text-align: center;">حالة القضية  </th>
                                <th style="width: 25%; text-align: center;">الجهة المخولة بالإجراء الإداري</th>
                        ...
                        <tbody>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:UniversityStudentIssues %>' SelectCommand="IssuesSearch" SelectCommandType="StoredProcedure">
                                <SelectParameters>
