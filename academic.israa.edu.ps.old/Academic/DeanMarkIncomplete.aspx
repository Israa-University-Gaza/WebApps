<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="DeanMarkIncomplete.aspx.cs" Inherits="Academic_DeanMarkIncomplete" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#DeanMarkIncomplete').addClass("active open");
        });
    </script>
</asp:Content>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; font-size: 12px; padding: 5px">
                                                <asp:TextBox ID="txtFinalMark" runat="server" CssClass="form-control" Style="height: 26px; width: 100px; text-align: center;" Text='<%# Eval("FinalMark") %>' Enabled='<%# !Convert.ToBoolean(Eval("TeacherAccreditation").ToString()) %>'></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Button ID="btnSetFinalMarkIncomplete" runat="server" Text="حفظ" CssClass="btn green" Style="height: 26px; padding: 0 15px" OnClick="btnSetFinalMarkIncomplete_Click" Enabled='<%# !Convert.ToBoolean(Eval("TeacherAccreditation").ToString()) %>' />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
