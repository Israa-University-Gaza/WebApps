<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterEmployeesTotalHours.aspx.cs" Inherits="Academic_SemesterEmployeesTotalHours" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#SemesterEmployeesTotalHours').addClass("active");
        });
    </script>
