...
public partial class Academic_DeanOfferCourse : UserPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                if (!Permissions.Contains("DeanOfferCourse"))
                {
                    Response.Redirect("Default.aspx");
                }
            }
