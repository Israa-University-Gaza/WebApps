...
public partial class Academic_StudentInstallmentAccreditation : UserPage
{
    ...
    protected string EmployeeID; /* Added By RSR */
    protected void Page_Load(object sender, EventArgs e)
    {
        UserPage userpage = new UserPage(); /* Added By RSR */
        EmployeeID = userpage.EmployeeID; /* Added By RSR */
        DataBind();
    ...
    protected void btnAccrediteStudentInstallment_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListViewItem item in ListView1.Items)
        {
            ...
            //ShowToast(this, "RSR>>" + ((CheckBox)item.FindControl("cbStudentInstallment")).Checked, "", "success");
