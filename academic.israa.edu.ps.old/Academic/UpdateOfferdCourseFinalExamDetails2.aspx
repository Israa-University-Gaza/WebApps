<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateOfferdCourseFinalExamDetails2.aspx.cs" Inherits="FinalExam_UpdateOfferdCourseFinalExamDetails2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#UpdateOfferdCourseFinalExamDetails2').addClass("active open");
            $('#UpdateOfferdCourseFinalExamDetails2 a').css("background-color", "#575757");
            $('#UpdateOfferdCourseFinalExamDetails2 a span.arrow').addClass("open");
        });
    </script>
</asp:Content>
    ...
    <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li>
            <button data-close-others="true" data-delay="1000" data-hover="dropdown" data-toggle="dropdown" class="btn font-ha dropdown-toggle" style="padding: 0px!important; background-color: #FAFAFA!important;" type="button">
                <span>مواعيد الإمتحانات</span> <i class="fa fa-angle-down"></i>
            </button>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><%# Eval("CourseName") %></td>
                                                ...
                                                <td style="text-align: center">
                                                    <asp:TextBox ID="txtFinalExamDate" runat="server" CssClass="form-control date-picker" Text='<%# Eval("FinalExamDate") %>'></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtFinalExamFrom" runat="server" CssClass="form-control text-center" Text='<%# Eval("FinalExamTimeFrom1") %>'></asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="txtFinalExamTo" runat="server" CssClass="form-control text-center" Text='<%# Eval("FinalExamTimeTo1") %>'></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                    ...
                    <div class="form-actions fluid">
                        <div class="row">
                            <div class="col-md-offset-6 col-md-6">
                                <asp:LinkButton ID="BtnSaveAll" runat="server" CssClass="btn blue" OnClick="BtnSaveAll_Click">حفظ</asp:LinkButton>
                            </div>
                        </div>
                    </div>
