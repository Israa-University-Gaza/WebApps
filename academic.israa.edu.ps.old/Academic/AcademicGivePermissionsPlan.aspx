<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicGivePermissionsPlan.aspx.cs" Inherits="Academic_AcademicGivePermissionsPlan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#AcademicPlan_2 a').css("background-color", "#575757");
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                                ...
                                                SelectCommand="SELECT * FROM [Action] WHERE  (AGroup='3HeadPlanGroup' or AGroup='2DeanPlanGroup' or AGroup='1AcademicPlanGroup' or AGroup='PlanCourseGroup')  AND ([IsDelete] = 0) order by AGroup"></asp:SqlDataSource>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
