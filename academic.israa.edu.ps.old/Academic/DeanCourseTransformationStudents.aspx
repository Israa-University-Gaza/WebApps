<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="DeanCourseTransformationStudents.aspx.cs" Inherits="Academic_DeanCourseTransformationStudents" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#DeanCourseTransformationStudents').addClass("active open");
        });
    </script>
</asp:Content>
