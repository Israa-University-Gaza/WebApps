<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="PTEmployeeStudyTable.aspx.cs" Inherits="Academic_PTEmployeeStudyTable" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#StudyTable_15 a').css("background-color", "#575757");
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>جدول محاضر بارت تايم</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <asp:DropDownList ID="ddlPTEmployee" runat="server" CssClass="select2_category form-control" DataSourceID="SqlDataSource8" DataTextField="Name" DataValueField="ID" AutoPostBack="true" OnSelectedIndexChanged="ddlEmployee_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <div class="row" style="padding-top: 15px;">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                            ...
                                            <SelectParameters>
                                                <asp:Parameter DefaultValue="9999" Name="EmployeeID" Type="Int32" />
                                                <asp:ControlParameter ControlID="ddlPTEmployee" PropertyName="SelectedValue" Name="PTEmployeeID" Type="Int32" />
                                ...
                                <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                                    <div class="col-xs-11" style="text-align: center;">
                                        <% if (ddlPTEmployee.SelectedIndex > 0)
                                            { %>
