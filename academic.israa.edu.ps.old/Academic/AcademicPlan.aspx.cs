...
public partial class Academic_AcademicPlan : UserPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (IsPermissionsContains("AcademicPlan"))
        {
    ...
    {
        if (ValidateControls(new WebControl[] { txtPlanNum, ddlProgram, ddlCollege, ddlDepartment, txtYear }))
        {
            if (DataAccess.PlanAddEdit(lblPlanID.Text, txtPlanNum.Text, ddlDepartment.SelectedValue, txtYear.Text,true,true, EmployeeID) > 0)
            {
