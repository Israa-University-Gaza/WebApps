...
public partial class Academic_ModelReport : UserPage
{
    ...
    protected void lbSemesterCoursePDF_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("SemesterCourse", @"Academic\Reports\SemesterCourse.rdlc", a1, a2);
    }
    ...
    protected void lbAccreditationPlans_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("AccreditationPlans", @"Academic\Reports\AccreditationPlans.rdlc", a1, a2);
    }
    ...
    protected void lbConstantsCourse_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("ConstantsCourse", @"Academic\Reports\ConstantsCourse.rdlc", a1, a2);
    }
    protected void lbDepartmentSectionData_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("DepartmentSectionData", @"Academic\Reports\DepartmentSectionData.rdlc", a1, a2);
    }
    ...
    protected void lbSpecialtiesAvailablePDF_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("SpecialtiesAvailable", @"Academic\Reports\SpecialtiesAvailable.rdlc", a1, a2);
    }
    ...
    protected void lbUnacceptedStudents_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("UnacceptedStudents", @"Academic\Reports\UnAcceptanceStudent.rdlc", a1, a2);
    }
    protected void lbGetDepartmentWishesCountReport_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("GetDepartmentWishes", @"Academic\Reports\GetDepartmentWishesCountReport.rdlc", a1, a2);
    }
    protected void lbacceptedStudents_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("acceptedStudents", @"Academic\Reports\AcceptanceStudent.rdlc", a1, a2);
    }
    ...
    protected void lbPlansAndDepartments_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("PlansAndDepartments", @"Academic\Reports\PlansAndDepartments.rdlc", a1, a2);
    }
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("StdPayFull", @"Academic\Reports\StdPayFull.rdlc", a1, a2);
    }
}