...
public partial class Academic_TeacherStudyTable : UserPage
{
    ...
    protected void lbStudyTablePDF_Click(object sender, EventArgs e)
    {
        ...
        a2.Add(DataAccess.GetTeacherStudyTable(ddlEmployee.SelectedValue, "", "15"));
        a2.Add(DataAccess.GetTeacherStudyTableInfo(ddlEmployee.SelectedValue, "", "15"));
