<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="HeadOfferdCourseManage.aspx.cs" Inherits="Academic_HeadOfferdCourseManage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#HeadOffer_2 a').css("background-color", "#575757");
                            ...
                            <table class="table table-condensed table-hover">
                                ...
                                <tbody>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <% if (Permissions.Contains("HeadOfferdCourseAccreditation"))
                                                       { %>
                                                    <asp:Button ID="btnAccrediation" runat="server" class="btn default btn-xs black" Text="إعتماد" OnClick="btnAccrediation_Click" Visible='<%# (Eval("HeadAccreditation").ToString() != "True")%>' />
                                                    <% } %> 
                                                </td>
                                                <td style="text-align: center">
                                                    ...
                                                    <% } %>
                                                    <% if (Permissions.Contains("HeadOfferdCourseDelete"))
                                                       { %>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>"
                                        SelectCommand="GetHeadOfferdCourses" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
