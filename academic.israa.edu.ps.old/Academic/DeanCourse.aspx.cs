...
public partial class Academic_DeanCourse : UserPage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validate && IntValidate)
        {
            ...
            //DataAccess.CourseAddEdit(lblCourseID.Text, txtCourseCode.Text, txtArName.Text, txtEnName.Text, "", ddlDepartment.SelectedValue, ddlCCourseType.SelectedValue, ddlCourseType.SelectedValue, txtNumOfHours.Text, "0", cbHaveLab.Checked, cbHaveDiscussion.Checked, cbActive.Checked, (ddlPreRequest.SelectedIndex > 0) ? ddlPreRequest.SelectedValue : "", EmployeeID);
    ...
    protected void btnCourseSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            lblCourseMsg.Text = "لا يوجد نتائج للبحث";
        }
    }
}