                ...
                <div class="portlet-body">
                    <div class="form-group  col-md-6">
                        ...
                        <div class="col-md-9">
                            ...
                            <asp:Label ID="lblEmployeeID" runat="server" Text='<%# EmployeeID%>' Visible="false"></asp:Label><!-- Added by RSR -->
                        </div>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr class= '<%# (Convert.ToBoolean(Eval("Accreditation").ToString()))? "success" : "" %>'>
                                            <td style="text-align: center;">
                                                ...
                                                <asp:Label ID="InstallmentOrderID" runat="server" Text='<%# Eval("ID") %>' Visible="True"></asp:Label>
                                            </td>
