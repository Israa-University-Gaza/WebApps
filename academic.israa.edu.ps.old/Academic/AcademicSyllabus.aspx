<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicSyllabus.aspx.cs" Inherits="Academic_AcademicSyllabus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#Syllabus_3 a').css("background-color", "#575757");
            $('#Syllabus_1 a span.arrow').addClass("open");
        });
    </script>
</asp:Content>
        ...
        <div class="portlet box red">
            ...
            <div class="portlet-body">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                             <th style="text-align: center; width: 10%">رقم المساق</th>
                    ...
                    <tbody>
                        ...
                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:isra %>' SelectCommand="GetSyllabus" SelectCommandType="StoredProcedure">
                            ...
                            <SelectParameters>
                                ...
                                <asp:ControlParameter ControlID="lbPlaceID" PropertyName="Text" DefaultValue="4" Name="PlaceID" Type="Int32"></asp:ControlParameter>
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </tbody>
                </table>
