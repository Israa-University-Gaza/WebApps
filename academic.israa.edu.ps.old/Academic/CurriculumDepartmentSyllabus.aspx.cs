...
public partial class Academic_CurriculumDepartmentSyllabus : UserPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Permissions.Contains("CurriculumDepartmentSyllabus"))
        {
            lbEmployeeID.Text = "5017";
            lbPlaceID.Text = "4";
        }
    ...
    protected void lbPrint_Click(object sender, EventArgs e)
    {
        ...
        CreatePDF("SyllabusReport_" + id, @"Academic\Reports\SyllabusReport.rdlc", a1, a2);
    }
