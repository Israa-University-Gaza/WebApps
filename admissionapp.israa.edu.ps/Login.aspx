...
<head>
    <meta charset="utf-8" />
    <title>طلب الإلتحاق | تسجيل الدخول</title>
...
<body class="login">
    ...
    <form id="form1" runat="server">
        <div class="content">
            ...
            <h3 class="form-title font-ha" style="text-align: center">تقديم طلب الإلتحاق</h3>

            <div id="loginResponse" runat="server" class="alert hide" clientidmode="Static">
                <asp:Label ID="lblMsg" runat="server" Text=""></asp:Label>
                <button class="close" data-close="alert"></button>
            </div>
            <div class="form-group">
                <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                <label class="control-label visible-ie8 visible-ie9">الرجاء ادخال الرقم الجامعي</label>
                <div class="input-icon">
                    <i class="fa fa-user"></i>
                    <asp:TextBox ID="txtStudentNo" runat="server" placeholder="الرقم الجامعي" autocomplete="off" class="form-control placeholder-no-fix"></asp:TextBox>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">الرجاء ادخال رقم الجلوس</label>
                <div class="input-icon">
                    <i class="fa fa-lock"></i>
                    <asp:TextBox ID="txtTawjehyNo" runat="server" autocomplete="off" placeholder="الرجاء ادخال رقم الجلوس" class="form-control placeholder-no-fix" TextMode="Password"></asp:TextBox>
                </div>
            </div>
            <div class="form-actions">
                <asp:Button ID="btnLogin" runat="server" class="btn blue pull-right" OnClick="btnLogin_Click" Text="دخول" />
            </div>
        </div>
    </form>
    <!-- END LOGIN -->
