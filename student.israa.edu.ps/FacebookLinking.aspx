<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FacebookLinking.aspx.cs" Inherits="FacebookLinking" %>

<!DOCTYPE html>
<html lang="ar" class="no-js">
<head>
    <meta charset="utf-8" />
    <title>الخدمات الإلكترونية | تسجيل الدخول</title>
...
<body class="login">
    ...
    <form id="form2" runat="server">
        <div class="content">
            ...
            <h3 class="form-title" style="text-align: center">الخدمات الإلكترونية - صفحة الطالب</h3>
            ...
            <div class="form-group">
                ...
                <label class="control-label visible-ie8 visible-ie9">الرقم الجامعي</label>
                <div class="input-icon">
                    <i class="fa fa-user"></i>
                    <asp:TextBox ID="txtStudentNo" runat="server" placeholder="الرقم الجامعي" class="form-control placeholder-no-fix"></asp:TextBox>
                </div>
            </div>
            <div class="form-group">
