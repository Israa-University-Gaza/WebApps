<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="StdSemesterTranscript.aspx.cs" Inherits="Student_StdSemesterTranscript" %>
                ...
                <div class="portlet-body">
                    <div class="row">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource8" runat="server"
                            ConnectionString="<%$ ConnectionStrings:isra %>"
                            SelectCommand="GetStdSemesterBySemesterID" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                        ...
                        <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                            <div class="col-xs-11" style="text-align: center;">
                                <strong>لم يتم التسجيل هذا الفصل </strong>
