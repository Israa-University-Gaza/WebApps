<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="MidtermExamsTable.aspx.cs" Inherits="Student_MidtermExamsTable" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            $('.page-sidebar-menu li').removeClass("active");
            $('#MidtermExamsTable').addClass("active");
        });
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">جدول الإمتحانات النصفية</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>جدول الإمتحانات النصفية</div>
                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:isra %>"
                                    SelectCommand="GetStdMidtermExamsTable" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
