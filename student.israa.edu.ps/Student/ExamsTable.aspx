<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="ExamsTable.aspx.cs" Inherits="Student_ExamsTable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">جدول الإمتحانات</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>جدول الإمتحانات</div>
                </div>
                <div class="portlet-body">
<div class="row">
                        <div class="col-md-10">
                            <div class="alert alert-success">
                                <h3><strong class="text-success">تأكيد!</strong> هذا جدول الامتحانات النهائية</h3>
                                <a  href="../cc2c7140-2100-4977-9c78-a3b3317007d4.pdf"> <h4 style="color: red">تعليمات خاصة بالطلبة في فترة الامتحانات </h4></a>

                                </div>                       </div>
                    </div>                    <% if (ddlStdSemester.Items.Count > 0)
                       { %>
                                ...
                                <asp:Repeater ID="Repeater3" runat="server" DataSourceID="SqlDataSource2">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center"><%# Eval("ExamDate") %></span></td>
