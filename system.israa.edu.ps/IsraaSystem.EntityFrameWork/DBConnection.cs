...
namespace IsraaSystem.DataAccess
{
    public class DBConnection
    {
        ...
        {
            string connetionString = "Data Source=israa.edu.ps;Initial Catalog=IsraaHumanResource;User Id=dbuser;Password=islam123qwe!@#QWE;";
        ...
        protected static SqlConnection GetIsraaAcademicConnection()
        {
            ...
            string connetionString = "Data Source=israa.edu.ps;Initial Catalog=IsraaAcademic;User Id=dbuser;Password=islam123qwe!@#QWE;";
        ...
        {
            string connetionString = "Data Source=israa.edu.ps;Initial Catalog=IsraPermission;User Id=dbuser;Password=islam123qwe!@#QWE;";
        ...
        {
            string connetionString = "Data Source=israa.edu.ps;Initial Catalog=IsraPermissions;User Id=dbuser;Password=islam123qwe!@#QWE;";
            //string connetionString = "data source=DESKTOP-0QD1UV6;initial catalog=IsraPermission;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework;";
            SqlConnection israaHumanResourceConnection = new SqlConnection(connetionString);
            return israaHumanResourceConnection;
        }
        ...
        {
            string connetionString = "Data Source=israa.edu.ps;Initial Catalog=IsraData;User Id=dbuser;Password=islam123qwe!@#QWE;";
            //string connetionString = "data source=DESKTOP-0QD1UV6;initial catalog=IsraPermission;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework;";
