...
function DataTableGo() {
    a.init({
        ...
        dataTable: {
	        buttons: [
...

		        {
			        ...
			        init: function (dt, node, config) {
                        $(node).attr('href', '/Repository/MaterialUnit/Add');
			        }
		        }
	        ],
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a href="/Repository/MaterialUnit/Edit/` +
                            data +
                            `" class="pop-up-lg btn btn-xs green btn-outline"><i class="fa fa-search"></i>تعديل </a>`
                            + `<a href="/Repository/MaterialUnit/Delete/` +
                            data +
            ...
            ajax: { url: "/Repository/MaterialUnit/LoadData" },
