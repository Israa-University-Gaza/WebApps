...
var TableDatatablesButtons = function () {
  ...
  var initTable1 = function () {
    ...
    var oTable = table.dataTable({
      ...
      "ajax": {
          "url": '/Repository/TransactionType/LoadData',
        "type": "POST",
        "datatype": "json",
        "data": function (d) {
      ...
      "columns": [
...

        {
          ...
          render: function (data, type, row) {
              ...
              return `<a href="/Repository/TransactionType/Delete/` + data + `" data-toggle="tooltip" data-placement="right" title="" class="btn btn-xs red-sunglo confirm" data-title="حذف" data-msg="هل أنت متأكد من أنك تود الحذف ؟" data-action="حذف" data-ajax-update="#refresh-list" data-original-title="حذف"><i class="fa fa-times"></i> حذف</a>`
              +
              `<a href="/Repository/TransactionType/Edit/` + data + `" class="pop-up-lg btn btn-xs green-meadow"><i class="fa fa-search"></i>تعديل</a>`;
      ...
      buttons: [

        {
          ...
          init: function (dt, node, config) {
              $(node).attr('href', '/Repository/TransactionType/Add');
          }
        },
