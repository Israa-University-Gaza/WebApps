...
function DataTableGo() {
    a.init({
        ...
        dataTable: {
            ...
            ajax: { url: "/Repository/Transaction/LoadExportData" },
            "columns": [
                 { "data": "Id", "name": "Id" },
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a href="/Repository/Transaction/EditExport/` + data + `" class="pop-up-lg btn btn-xs green btn-outline"><i class="fa fa-search"></i>تعديل</a>`
                           +
                           `<a href="/Repository/TransactionDetails/IndexExport?transactionId=` + data + `"class="btn btn-xs green btn-outline">تفاصيل</a>`
            ...
            buttons: [
                ...
                { extend: 'colvis', className: 'btn dark btn-outline', text: 'الحقول', exportOptions: { columns: ':visible' } },
                {
                    ...
                    init: function (dt, node, config) {
                        $(node).attr('href', '/Repository/Transaction/AddExport');
                    }
                }
            ],
