...
function DataTableGo() {
    a.init({
        ...
        dataTable: {
            ...
            buttons: [
...

	            {
		            ...
		            init: function (dt, node, config) {
                        $(node).attr('href', '/Repository/Transaction/AddDestruction');
		            }
	            }
            ],
            "columns": [
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a href="/Repository/Transaction/EditDestruction/` + data + `" class="pop-up-lg btn btn-xs green btn-outline"><i class="fa fa-search"></i>تعديل</a>`
                            +
                            `<a href="/Repository/TransactionDetails/IndexDestruction?transactionId=` + data + `"class="btn btn-xs green btn-outline">تفاصيل</a>`
            ...
            ajax: {
                "url": '/Repository/Transaction/LoadDestructionData',
