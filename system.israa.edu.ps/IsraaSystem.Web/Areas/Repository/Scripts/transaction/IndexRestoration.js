...
function DataTableGo() {
    a.init({
        ...
        dataTable: {
            ...
            buttons: [
...

                {
                    ...
                    init: function (dt, node, config) {
                        $(node).attr('href', '/Repository/Transaction/AddRestoration');
                    }
                }
            ],
            "columns": [
                ...
                { "data": "SupplierName", "name": "Supplier.Name" },
                {
                    data: 'IsActive',
                    name: "IsActive",
                    render: function (data, type, row) {
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a href="/Repository/Transaction/EditRestoration/` + data + `" class="pop-up-lg btn btn-xs green btn-outline"><i class="fa fa-search"></i>تعديل</a>`
                            +
                            `<a href="/Repository/TransactionDetails/IndexRestoration?transactionId=` + data + `"class="btn btn-xs green btn-outline">تفاصيل</a>`
            ...
            ajax: {
                "url": '/Repository/Transaction/LoadRestorationData',
