...
function DataTableGo() {
    a.init({
        ...
        dataTable: {
            ...
            buttons: [
...

                {
                    ...
                    init: function (dt, node, config) {
                        $(node).attr('href', '/Repository/Transaction/AddInventory');
                    }
                }
            ],
            "columns": [
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a href="/Repository/Transaction/EditInventory/` + data + `" class="pop-up-lg btn btn-xs green btn-outline"><i class="fa fa-search"></i>تعديل</a>`
                            +
                            `<a href="/Repository/TransactionDetails/IndexInventory?transactionId=` + data + `"class="btn btn-xs green btn-outline">تفاصيل</a>`
            ...
            ajax: {
                "url": '/Repository/Transaction/LoadInventoryData',
