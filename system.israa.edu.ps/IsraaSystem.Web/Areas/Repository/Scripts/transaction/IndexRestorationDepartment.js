...
function DataTableGo() {
    a.init({
        ...
        dataTable: {
            ...
            buttons: [
...

                {
                    ...
                    init: function (dt, node, config) {
                        $(node).attr('href', '/Repository/Transaction/AddRestorationDepartment');
                    }
                }
            ],
            "columns": [
                { "data": "Id", "name": "Id" },
                { "data": "TransactionTypeName", "name": "TransactionType.Name" },
                {
...

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a href="/Repository/Transaction/EditRestorationDepartment/` + data + `" class="pop-up-lg btn btn-xs green btn-outline"><i class="fa fa-search"></i>تعديل</a>`
                            +
                            `<a href="/Repository/TransactionDetails/IndexRestorationDepartment?transactionId=` + data + `"class="btn btn-xs green btn-outline">تفاصيل</a>`
            ...
            ajax: {
                "url": '/Repository/Transaction/LoadRestorationDepartmentData',
