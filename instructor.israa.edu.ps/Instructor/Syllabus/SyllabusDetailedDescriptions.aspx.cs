...
public partial class Instructor_Syllabus_SyllabusDetailedDescriptions : UserPage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (Validate)
        {
            DataTable DT = DataAccess.SyllabusDetailedDescriptionAddEdit(lblSyllabusDetailedDescriptionID.Text, lblSyllabusID.Text, txtWeekName.Text, txtArUnitName.Text, txtEnUnitName.Text, EmployeeID);
    ...
    protected void lbSyllabusDetailedDescriptionDelete_Click(object sender, EventArgs e)
    {
        ListViewItem li = (ListViewItem)((LinkButton)sender).Parent;
        string id = ((Label)li.FindControl("SyllabusDetailedDescriptionID")).Text;
        DataTable DT = DataAccess.SyllabusDetailedDescriptionDelete(id, EmployeeID);
