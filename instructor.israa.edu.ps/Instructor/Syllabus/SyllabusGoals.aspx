<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="SyllabusGoals.aspx.cs" Inherits="Instructor_Syllabus_SyllabusGoals" %>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red uppercase font-ha">توصيف مساق <asp:Label ID="lblCourseName" runat="server"></asp:Label> - أهداف المساق</span>
                            </div>
                        </div>
                        <div class="col-md-5">
                                            ...
                                            <div class="form-actions fluid row">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-4">
                                                        <asp:Button ID="btnSave" runat="server" Text="حفظ الهدف" CssClass="btn green" OnClick="btnSave_Click" />
                                                    </div>
                ...
                <div class="portlet-title">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="caption">
                                <i class=" icon-layers font-red"></i>
                                <span class="caption-subject font-red uppercase font-ha">توصيف المساق - أهداف المساق</span>
                            </div>
                        </div>
                        <div class="col-md-8">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 43%">الهدف بالانجليزية</th>
                                    ...
                                    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lbSyllabusGoalEdit" runat="server" CssClass="btn default btn-xs green" OnClick="lbSyllabusGoalEdit_Click" Visible='<%# ( (Eval("InstructorAccreditSyllabus").ToString() == "0")) ? true:false %>'> <i class="fa fa-edit"></i> تحرير</asp:LinkButton>
                                                    <asp:LinkButton ID="lbSyllabusGoalDelete" runat="server" CssClass="btn default btn-xs purple" OnClick="lbSyllabusGoalDelete_Click" Visible='<%# ( (Eval("InstructorAccreditSyllabus").ToString() == "0")) ? true:false %>' OnClientClick="return confirm('هل انت متاكد من عملية الحذف؟')"><i class="fa fa-trash-o"></i> حذف</a></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:ListView>
                                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:IsraaAcademic %>' SelectCommand="GetSyllabusGoal" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
