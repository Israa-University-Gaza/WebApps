<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="JobQuestionAddEditEn.aspx.cs" Inherits="Instructor_JobQuestionAddEditEn" ValidateRequest="false" %>
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#EExam, #JobQuestionAddEditEn').addClass('active');
                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <asp:DropDownList ID="ddlJob" runat="server" DataSourceID="SqlDataSource1" DataTextField="EnName" DataValueField="ID" CssClass="form-control"></asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IsraaEmploymentExam %>"
                                        SelectCommand="Select ID, [EnName] From Job Where EmployeeID=@EmployeeID and [IsActive]=1 and [IsDelete]=0 union select -1, N'Chosse Job'">
                                        <SelectParameters>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:IsraaEmploymentExam %>"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:IsraaEmploymentExam %>"
