<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="SectionStudentsFinalMarks.aspx.cs" Inherits="Instructor_SectionStudentsFinalMarks" %>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtWorkMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# Eval("WorkMark") %>' Enabled="false"></asp:TextBox></td>
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtMidtermMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# (Convert.ToBoolean(Eval("IsMidtermIncomplete").ToString())) ? "من 70" :  ((Convert.ToBoolean(Eval("IsMidtermNoMark").ToString())) ? "غياب" : Eval("MidtermMark")) %>' Enabled="false"></asp:TextBox></td>
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtFinalMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# ((Convert.ToBoolean(Eval("IsFinalNoMark").ToString())) ? "غياب" : Eval("FinalMark")) %>' Enabled='<%#(!Convert.ToBoolean(Eval("finalTeacherAccreditation").ToString())) ? true:false %>'></asp:TextBox></td>
                                                                <td style="text-align: center; font-size: 12px; padding: 10px;"><span id="TotalMark"><%# Eval("TotalMark") %></span></td>
                                                                <td>
                                                                    <asp:Button ID="btnSaveMark" runat="server" Text="حفظ" CssClass="btn green" Style="height: 26px; padding: 0 15px" OnClick="btnSaveMark_Click" Enabled='<%#(!Convert.ToBoolean(Eval("finalTeacherAccreditation").ToString())) ? true:false %>' />
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:ListView>
