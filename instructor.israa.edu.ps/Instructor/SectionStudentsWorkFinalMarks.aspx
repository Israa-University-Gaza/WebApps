                                                    ...
                                                    <asp:ListView ID="ListView1" runat="server">
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtMidtermMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Enabled="false" Text='<%# (Convert.ToBoolean(Eval("IsMidtermIncomplete").ToString())) ? "من 70" :  ((Convert.ToBoolean(Eval("IsMidtermNoMark").ToString())) ? "غياب" : Eval("MidtermMark")) %> '></asp:TextBox></td>
                                                                <td style="padding: 6px 28px">
