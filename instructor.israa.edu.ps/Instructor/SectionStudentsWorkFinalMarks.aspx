                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtWorkMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# Eval("WorkMark") %>' Enabled='<%#((!((Convert.ToBoolean(Eval("finalTeacherAccreditation").ToString()))  || (Convert.ToBoolean(Eval("finalDeanAccreditation").ToString()))  || (Convert.ToBoolean(Eval("finalAcademicAccreditation").ToString())))) && (Eval("CourseTypeID").ToString()=="1" || Eval("CourseTypeID").ToString()=="2" ) && (Eval("OfferdCourseTypeID").ToString()=="1" || Eval("OfferdCourseTypeID").ToString()=="4")) ? true:false %>'></asp:TextBox></td>
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtMidtermMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# Eval("MidtermMark") %>' Enabled="false"></asp:TextBox></td>
                                                                <td style="padding: 6px 28px">
