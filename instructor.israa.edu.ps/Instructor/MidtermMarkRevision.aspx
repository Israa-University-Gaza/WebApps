<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="MidtermMarkRevision.aspx.cs" Inherits="Instructor_MidtermMarkRevision" %>
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#StudentMarks, #MidtermMarkRevision').addClass("active");
        });
    </script>
</asp:Content>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="width: 12%; text-align: center">درجة الطالب</th>
                                        <th scope="col" style="width: 15%; text-align: center">التعديل</th>
                                ...
                                <tbody>
                                    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource5">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblMidtermMark" runat="server" Text='<%# Eval("MidtermMark") %>' Visible="false"></asp:Label>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <%# ((Convert.ToBoolean(Eval("IsMidtermIncomplete").ToString())) ? "من 70" :  ((Convert.ToBoolean(Eval("IsMidtermNoMark").ToString())) ? "غياب" : Eval("MidtermMark").ToString())) %>
                                                </td>
                                                <td style="padding: 6px 8px">
                                                    <asp:TextBox ID="txtMidtermMark" runat="server" CssClass="form-control" Style="height: 26px; text-align: center;" Text='<%# Eval("NewMidtermMark") %>' Enabled='<%# !(Convert.ToBoolean(Eval("IsAcceptRequest").ToString()) || Convert.ToBoolean(Eval("IsRejectRequest").ToString())) %>'></asp:TextBox></td>
                                                <td style="text-align: center;">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                        ...
                                        SelectCommand="GetInstructorMidtermMarkRevision" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
