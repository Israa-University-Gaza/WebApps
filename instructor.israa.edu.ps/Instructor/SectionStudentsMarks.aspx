<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="SectionStudentsMarks.aspx.cs" Inherits="Instructor_SectionStudentsMarks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#StudentMarks, #SectionStudentsMarks').addClass("active");
        });
    </script>
</asp:Content>
                                            ...
                                            <table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="width: 10%; text-align: center">اختبار عملي</th>
                                                        <th scope="col" style="width: 10%; text-align: center">كفاءات مهنية</th>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtWorkMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# Eval("WorkMark") %>' Enabled='<%#(!Convert.ToBoolean(Eval("TeacherAccreditation").ToString())) ? true:false %>'></asp:TextBox></td>
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtMidtermMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# (Convert.ToBoolean(Eval("IsMidtermIncomplete").ToString())) ? "من 70" :  ((Convert.ToBoolean(Eval("IsMidtermNoMark").ToString())) ? "غياب" : Eval("MidtermMark")) %>' Enabled='<%#(!Convert.ToBoolean(Eval("TeacherAccreditation").ToString())) ? true:false %>'></asp:TextBox></td>
                                                                <td style="padding: 6px 28px">
                                                                    <asp:TextBox ID="txtFinalMark" runat="server" CssClass="form-control mark" Style="height: 26px; text-align: center;" Text='<%# Eval("FinalMark") %>' Enabled='<%#(!Convert.ToBoolean(Eval("TeacherAccreditation").ToString())) ? true:false %>'></asp:TextBox></td>
                                                                <td style="text-align: center; font-size: 12px; padding: 10px;"><span id="TotalMark"><%# Eval("TotalMark") %></span></td>
                                                                <td>
                                                                    <asp:Button ID="btnSaveMark" runat="server" Text="حفظ" CssClass="btn green" Style="height: 26px; padding: 0 15px" OnClick="btnSaveMark_Click" Enabled='<%#(!Convert.ToBoolean(Eval("TeacherAccreditation").ToString())) ? true:false %>' />
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:ListView>
