<%@ Page Language="C#" AutoEventWireup="true" CodeFile="q.aspx.cs" Inherits="Instructor_q" %>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:IsraaEmploymentExam %>"
                                    SelectCommand="GetJobQuestions" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                            </div>
                        </div>
                    </div>
                </div>
