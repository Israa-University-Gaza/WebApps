...
public partial class Instructor_QuestionAddEditEn : UserPage
{
    ...
    protected void btnSaveQuestion_Click(object sender, EventArgs e)
    {
        ...
        {
            DataTable DT = DataAccess.QuestionAddEdit(lblQuestionID.Text, txtQuestionText.Text, ddlCourse.SelectedValue, ddlCoursePart.SelectedValue, ddlQuestionType.SelectedValue, ddlQuestionHardness.SelectedValue, "2", cbActive.Checked, EmployeeID);
