<%@ page title="" language="C#" masterpagefile="~/Instructor/MasterPage.master" autoeventwireup="true" codefile="FinalExamSections.aspx.cs" inherits="Instructor_FinalExamSections" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#AcademicMenu, #FinalExamSections').addClass("active");
        });
    </script>
</asp:Content>
...
<asp:content id="Content3" contentplaceholderid="PageTitlePlaceHolder" runat="Server">
    ...
    <span>جدول المراقبات النهائية</span>
</asp:content>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red uppercase font-ha">جدول المراقبات النهائية</span>
                            </div>
                        </div>
                    </div>
                </div>
