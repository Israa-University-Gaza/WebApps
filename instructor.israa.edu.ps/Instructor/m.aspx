<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="m.aspx.cs" Inherits="Instructor_m" %>
            ...
            <div class="portlet light portlet-fit bordered calendar">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlCourse" runat="server" class="select2_category form-control" DataSourceID="SqlDataSource2" DataTextField="CourseName" DataValueField="ID" AutoPostBack="true"></asp:DropDownList>
                        ...
                        <div class="col-md-12">
                            <div class="btn-group pull-right">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                        <asp:LinkButton ID="lbSelectedStudentsExamsDelete" runat="server" CssClass="btn" OnClick="lbSelectedStudentsExamsDelete_Click" OnClientClick="return confirm('هل انت متاكد من عملية الحذف؟')"><i class="fa fa-trash-o"></i> حذف المحدد</asp:LinkButton>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="text-align: center;">
                                                        <asp:Label ID="StudentExamID" runat="server" Text='<%# Eval("ID") %>' Visible="true"></asp:Label>
                                                    </td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <asp:TextBox ID="txtTime" runat="server" Text='<%# Eval("ReminingTime") %>'></asp:TextBox>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                            ConnectionString="<%$ ConnectionStrings:IsraaEExam %>"
                                            SelectCommand="GetSectionStudentsExams" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
