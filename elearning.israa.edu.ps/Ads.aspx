<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ads.aspx.cs" Inherits="Ads" %>
...
<body topmargin="0" class="">
                        ...
                        <div>
                            <div class="panel panel-default transparent">
                                <div class="text-center">
                                    <h4><strong>&nbsp;&nbsp; لوحة إعلانات البوابة </strong></h4>
                                </div>
                                <div class="br hr_custom "></div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-12" style="overflow: hidden;">
                                            <ul class="demo" style="overflow: hidden; height: 154px;">
                            ...
                            <li style="" class="news-item">
                                                <div>
                                                   &nbsp;<a href="Det.aspx?id=<%# Eval("id") %>"><%# Eval("Title") %> <span style="color:red"><%# Eval("dateentered").ToString().Split(' ')[0] %> </span></a>   
                                                </div>
                                            </li>
  ...
  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="EnJAZ_GetAll_EnJAZ_ads" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
  ...
  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="EnJAZ_GetAll_EnJAZ_ads" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
