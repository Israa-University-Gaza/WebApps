<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Det" %>
                            ...
                            <div>
                                <div class="panel panel-default transparent">
                                    <div class="text-center">
                                        ...
                                        <h4><strong>&nbsp;&nbsp; للتواصل مع الدائرة </strong></h4>
                                        <asp:Label ID="dt11" runat="server" Text=""></asp:Label>
                                    </div>
                                    <div class="br hr_custom "></div>
                                    <div class="panel-body" style="padding: 21px; direction: initial;">

                                        <div class="form-group">


                                            <span style="font-size: 18px;" class="glyphicon glyphicon-phone-alt">&nbsp;  0097082843433 &nbsp; </span>

                                        </div>
                                        <div class="form-group">


                                            <span style="font-size: 18px;" class="glyphicon glyphicon-globe">&nbsp;elearning@israa.edu.ps &nbsp;</span>

                                        </div>
                                        <div class="form-group">
                                            <div class="mapouter">
                                                <div class="gmap_canvas">
                                                    <iframe width="573" height="424" id="gmap_canvas" src="https://maps.google.com/maps?q=%D8%AC%D8%A7%D9%85%D8%B9%D8%A9%20%D8%A7%D9%84%D8%A7%D8%B3%D8%B1%D8%A7%D8%A1&t=&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                    ...
                    <div class="col-sm-4 col-md-6 visible-sm visible-xs hidden-lg hidden-md transparent2 ">
                        ...
                        <div>
                            <div class="panel panel-default transparent">
                                <div class="text-center">
                                    <h4><strong>
                                        <asp:Label ID="title1" runat="server" Text="title1"></asp:Label>
                                    </strong></h4>
