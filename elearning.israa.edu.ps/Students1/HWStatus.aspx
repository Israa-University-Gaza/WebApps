<%@ Page Title="" Language="C#" MasterPageFile="~/Students1/MasterPage.master" AutoEventWireup="true" CodeFile="HWStatus.aspx.cs" Inherits="Students_HWStatus" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="الحالة">
                                <ItemTemplate>
                                    ...
                                    <asp:Image ID="f_img"  ImageUrl="https://cdn2.iconfinder.com/data/icons/web-and-apps-interface/32/Cancel-512.png" Height="20px" Visible="False" Width="20px" runat="server" CssClass="لم يتم التسليم" />
                                     <asp:Image ID="t_img"  ImageUrl="https://cdn.iconscout.com/icon/free/png-256/right-true-verify-perfect-trust-64-32776.png" Height="20px" Width="20px" runat="server" Visible="False" CssClass="تم التسليم" /> 
                                     <br />
                                      <asp:Label ID="hw_stat" runat="server"></asp:Label>
                                      <asp:Label ID="hw_stat1"  Visible="False" CssClass="dot1"   runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
