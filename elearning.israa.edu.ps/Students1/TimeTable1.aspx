<%@ Page Title="" Language="C#" MasterPageFile="~/Students1/MasterPage.master" AutoEventWireup="true" CodeFile="TimeTable1.aspx.cs" Inherits="Students_TimeTable" %>
                                    ...
                                    <div class="main-timeline">
                                        ...
                                        <div class="timeline">
                                            <a href="<%# Eval("url") %>" class="timeline-content">
                                                <div class="timeline-year"><%# Eval("day") %></div>
                                                الساعة: <%# Eval("time") %>
