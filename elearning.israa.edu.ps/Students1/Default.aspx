<%@ Page Title="" Language="C#" MasterPageFile="~/Students1/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
">
        <div class="well">
          <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" text-align="center"  OnRowDataBound="GridView1_RowDataBound" DataSourceID="SqlDataSource1"  AllowSorting="True" CellPadding="10" CellSpacing="3" ForeColor="#333333" HorizontalAlign="Center" >
  ...
  <div class="col-sm-6 col-md-6">
    ...
    <div   class="col-sm-12 col-md-12">
      <div class="well">
        ...
        <br/>
          <span style="color:red"><asp:HyperLink ID="HyperLink6" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red" NavigateUrl="~/Students1/TimeTable.aspx">في حال عدم ظهور الجدول بالشكل الصحيح يرجى الضغط هنا </asp:HyperLink></span>
          
      </div>
           <div class="row">
                 <div   class="col-sm-12 col-md-12">
        <div class="well">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" text-align="center"  OnRowDataBound="GridView1_RowDataBound" DataSourceID="SqlDataSource1"  AllowSorting="True" CellPadding="10" CellSpacing="3" ForeColor="#333333" HorizontalAlign="Center" >
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="day" HeaderText="اليوم" SortExpression="day" />
                <asp:BoundField DataField="crs_name" HeaderText="اسم المساق" SortExpression="crs_name" />
