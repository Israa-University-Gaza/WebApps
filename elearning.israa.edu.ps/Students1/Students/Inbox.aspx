...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="modal-dialog" role="document">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" 
        SelectCommand="SELECT  ROW_NUMBER() OVER(ORDER BY id desc) AS Row#,[title], [seen], [to_name], [dt],[det], [id], [sender_id],replay, r_dt FROM [masseges] WHERE ([sender_id] = @to_id and isdelet=0)  ORDER BY id desc">
        <SelectParameters>
