...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lec.Text = r.lec_name(r.get_lec(Request.QueryString["crs"], Request.QueryString["section"]));
    }
    ...
    protected void Repeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (Repeater1.Items.Count == 0 && Repeater2.Items.Count == 0 && Repeater3.Items.Count == 0 && Repeater4.Items.Count == 0 && Repeater5.Items.Count == 0 && Repeater6.Items.Count == 0)
        {
