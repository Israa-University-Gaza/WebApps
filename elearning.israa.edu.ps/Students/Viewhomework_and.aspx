<%@ Page Title="" Language="C#" MasterPageFile="~/Students/MasterPage.master" AutoEventWireup="true" CodeFile="Viewhomework_and.aspx.cs" validateRequest="false" Inherits="Instructor_ViewAnnouncements" %>
...
<p class="text-center">
    ...
    <div class="form-group" style="text-align: center">
      ...
      <div>
          ...
          <asp:TextBox ID="Editor2" CssClass="form-control" Height="269px" TextMode="MultiLine" runat="server"></asp:TextBox>
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="table" EmptyDataText="لا يوجد مشاهدات">
        ...
        <div class="well">
            <h4><span style="font-size: 18px;" class="glyphicon glyphicon-equalizer"></span> اضافة تعليق   </h4>
             ...
             <asp:TextBox ID="Editor1" CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
