...
public partial class Instructor_ViewAnnouncements : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Browser.IsMobileDevice)
            Response.Redirect("Viewhomework_and.aspx?id="+Request.QueryString["id"]);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            {
                if (FileUpload1.PostedFile.ContentLength <= 31457280)
                {
                    ...
                    if (FileUpload1.PostedFile.ContentLength ==0 )
                    {
                        ...
                        Done.Visible = false;
                        notDone.Visible = true;
                        HyperLink6.NavigateUrl = "Viewhomework.aspx?id=" + Request.QueryString["id"];
                    }
                    else
                    {
                ...
                {
                    er.Visible = true;
                    ertxt.InnerText = "اقصى حجم 30 ميجا";
                }
            }
            else
            {
        ...
        {
            if(!FileUpload1.HasFile && Editor2.Text=="")
            {
                homework.Visible = false;
                Done.Visible = false;
                notDone.Visible = true;
