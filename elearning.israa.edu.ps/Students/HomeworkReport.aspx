...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
    <asp:gridview runat="server" autogeneratecolumns="False" datasourceid="SqlDataSource1" CssClass="table" EmptyDataText="لا يوجد واجبات مطروحة لهذا المساق" OnRowDataBound="Unnamed1_RowDataBound">
        <Columns>
...
where e_HomeWork.crs_id=@crs and e_HomeWork.section=@sec and e_HomeWork.sem=(select top 1 semester_id  from e_semester) ORDER BY e_HomeWork.id desc">
        <SelectParameters>
