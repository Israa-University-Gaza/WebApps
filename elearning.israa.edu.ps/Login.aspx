...
#somthing_sticky { top:200px;  position:fixed; z-index: 999999999999; left:0px}
...
<div id="somthing_sticky">
<a href="https://newstudents.israa.edu.ps/">
<img src="https://israa.edu.ps/morshed.png">
</a>
</div>
                            ...
                            <div class="col-lg-10 col-md-10">
                                ...
                                <div class="collapse navbar-collapse" id="slidemenu">
                                    <ul id="myUl" class="nav navbar-nav  right-border">
                                        ...
                                        <li><a style="color:red"  href="https://elearning.israa.edu.ps/TimeTable/help.pdf">نشرة إرشادية عن كيفية استخدام البوابة   </a></li>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="well">
                                <div class="alert alert-danger " runat="server" id="log">
                                    <strong>حدث الخطأ التالي</strong>
                                    <div>
...
<div class="col-sm-1 col-md-1">&nbsp;</div>
<div class="col-sm-8 col-md-8">
<b> <font color="red">عذراً يجب تسجيل مواد للفصل الدراسي الثاني للعام 2020/2021 لتنفيذ هذا الاجراء.</font><br>
...
<div class="br"></div>
    ...
    border-radius: 4px;">
                                    ...
                                    <div style="color: #7c3d18;"> <strong style="color: #7c3d18;">للمحاضرين: </strong>يرجى من سيادتكم ادخال المصادر الأكاديمية للفصل الأول.</div>
                                         <div style="color: #7c3d18;"> <strong style="color: #7c3d18;">للطلبة: </strong>يرجى التأكد من تسجيل المساقات للفصل الدراسي <strong>الأول</strong> .</div>
        ...
        <br>
                ...
                <div class="entry-box entry-box-1 radius2 text-center mb-4" style="border-color:forestgreen;">
                    <a class="d-flex flex-column justify-content-center">
                        ...
                        <div class="text" style="color:forestgreen">ملفات تعليمية</div>
                    </a>
                </div>
            </div>
        ...
        <div class="col-lg" style="width:250px">
                <div class="entry-box entry-box-1 radius2 text-center mb-4" style="border-color: blue;">
                    <a class="d-flex flex-column justify-content-center">
                        ...
                        <div class="text" style="color:blue">إعلانات   </div>
                    </a>
                </div>
            </div>
                        <div class="col-lg" style="width:250px">
                <div class="entry-box entry-box-1 radius2 text-center mb-4" style="border-color:#777777">
                    <a class="d-flex flex-column justify-content-center">
                        ...
                        <div class="text" style="color:#777777">روابط إثرائية  </div>
                    </a>
                </div>
            </div>
                        <div class="col-lg" style="width:250px">
                <div class="entry-box entry-box-1 radius2 text-center mb-4" style="border-color: #7c3d18">
                    <a class="d-flex flex-column justify-content-center">
                        <div id="vid" runat="server" class="count" style="font-size:35px;color:#7c3d18">3294</div>
                        <div class="text" style="color:#7c3d18">فيديو مسجل  </div>
                    </a>
                </div>
            </div>
                        <div class="col-lg" style="width:250px">
         ...
         <div class="col-sm-6 col-md-6">
               <iframe runat="server" id="fram" width="100%" height="315" src="https://www.youtube.com/embed/0Vkg4DxftfI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
