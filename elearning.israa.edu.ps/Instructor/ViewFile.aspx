<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="ViewFile.aspx.cs" validateRequest="false" Inherits="Instructor_ViewFile" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="col-sm-12 col-md-12">
        <div class="well">
            <h3><span style="font-size: 18px;" class="glyphicon glyphicon-asterisk"></span>&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text=""></asp:Label>
            </h3>
            <p class="text-center">
                ...
                <div class="form-group" style="text-align: center">
                    ...
                    <div>
                        <a runat="server" id="a">
                            <asp:Image ID="Image1" runat="server" Height="53px" /></a>
                    </div>
