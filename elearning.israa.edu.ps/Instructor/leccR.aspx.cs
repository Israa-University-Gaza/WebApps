...
public partial class Instructor_lecc : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["log"].ToString() == "110" || Session["log"].ToString() == "186")
        {
            d110.Visible = true;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            SqlDataAdapter DA = new SqlDataAdapter("select count(distinct path) from e_files where lec=" + DataBinder.Eval(e.Row.DataItem, "employeeNo").ToString(), conn);
            ...
            SqlDataAdapter DA1 = new SqlDataAdapter("SELECT COUNT(*) AS RowCounter FROM (SELECT  distinct crs_id,week_id,lec FROM e_HomeWork where lec=" + DataBinder.Eval(e.Row.DataItem, "employeeNo").ToString() + ") AS Q1", conn);
            ...
            SqlDataAdapter DA2 = new SqlDataAdapter("SELECT COUNT(*) AS RowCounter FROM (SELECT  distinct crs_id,week_id,lec FROM e_Announcements where lec=" + DataBinder.Eval(e.Row.DataItem, "employeeNo").ToString() + ") AS Q1", conn);
            ...
            SqlDataAdapter DA3 = new SqlDataAdapter("SELECT COUNT(*) AS RowCounter FROM (SELECT  distinct crs_id,week_id,lec FROM e_links  where lec=" + DataBinder.Eval(e.Row.DataItem, "employeeNo").ToString() + ") AS Q1", conn);
            ...
            SqlDataAdapter DA4 = new SqlDataAdapter("SELECT COUNT(*) AS RowCounter FROM (SELECT  distinct crs_id,week_id,lec FROM e_vids where lec=" + DataBinder.Eval(e.Row.DataItem, "employeeNo").ToString() + ") AS Q1", conn);
            ...
            SqlDataAdapter DA5 = new SqlDataAdapter("SELECT COUNT(*) AS RowCounter FROM (SELECT  distinct crs_id,week_id,lec FROM e_dialog where lec=" + DataBinder.Eval(e.Row.DataItem, "employeeNo").ToString() + ") AS Q1", conn);
        ...
        g2.DataSource = r.lec_COURS(Label3.Text);
        g2.DataBind();
        int tt = 0;
  ...
  SqlDataAdapter DA3 = new SqlDataAdapter("SELECT COUNT(*) AS RowCounter FROM (SELECT  distinct crs_id,week_id,lec FROM e_links where crs_id='" + crs_id + "' and section=" + sectionNum + ") AS Q1", conn);
            DataTable DT3 = new DataTable();
            DA3.Fill(DT3);
            try
            {
