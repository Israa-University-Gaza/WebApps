<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="lecc1.aspx.cs" EnableEventValidation="true"  Inherits="Instructor_lecc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
                         ...
                         <Columns>
                             ...
                             <asp:TemplateField HeaderText="المساقات">
                                 <ItemTemplate>
                                     ...
                                     <div style="text-align:center"><asp:GridView text-align="Center" ID="g2" runat="server" Font-Size="10pt"  AutoGenerateColumns="False" OnRowDataBound="g2_RowDataBound" HorizontalAlign="Center">
                                         <Columns>
    ...
    <asp:Button ID="Button1" runat="server" Text="XLS" OnClick="Button1_Click1" />
</asp:Content>
