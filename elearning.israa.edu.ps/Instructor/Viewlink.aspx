<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/MasterPage.master" AutoEventWireup="true" CodeFile="Viewlink.aspx.cs" validateRequest="false" Inherits="Instructor_ViewAnnouncements" %>
...
<p class="text-center">
    ...
    <div class="form-group" style="text-align: center">
      ...
      <div>
          <asp:hyperlink id="h1" runat="server">مشاهدة الرابط </asp:hyperlink>
             </div>
...
<p class="text-center">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand="SELECT [std_id], [name], [dt],  ROW_NUMBER() OVER (ORDER BY dt desc) row_num FROM [seen] WHERE (([typ] = @typ) AND ([re_id] = @re_id)) ORDER BY dt desc">
        <SelectParameters>
            <asp:Parameter DefaultValue="lin" Name="typ" Type="String" />
