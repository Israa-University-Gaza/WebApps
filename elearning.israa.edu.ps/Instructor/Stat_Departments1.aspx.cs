...
public partial class Instructor_Stat_Departments : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        GridView2.DataSource = r.RemoveDuplicateRows(dt, "employeeNo"); ;
        GridView2.DataBind();
    }
  ...
  e.Row.Visible = false;
           ...
           else
            {
                ...
                if (DataBinder.Eval(e.Row.DataItem, "employeeNo") != null)
                {
                    ...
                    SqlDataAdapter DA3 = new SqlDataAdapter("SELECT COUNT(*) AS RowCounter FROM (SELECT  distinct title FROM e_links  where  sem = (select top 1 semester_id from e_semester) and lec=" + DataBinder.Eval(e.Row.DataItem, "employeeNo").ToString() + ") AS Q1", conn);
