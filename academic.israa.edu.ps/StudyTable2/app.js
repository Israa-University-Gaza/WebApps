...
app.controller('AppController', function ($scope, $http, $compile, $log, Notification) {
    ...
    $scope.getAvailableRooms = function () {
        var parmeters = {
            selectedDay: $scope.lecture.selectedDay,
            selectedFromHour: $scope.lecture.selectedFromHour,
            selectedToHour: $scope.lecture.selectedToHour
        }
        $http.get('WebServices/GetAvailableRooms.ashx', { params: parmeters }).then(function (response) {
    ...
    $scope.alertOnEventClick = function (event, jsEvent, view) {
        ...
        $scope.lecture.selectedOfferedCourse = event.OfferdCourseID;
        $scope.lecture.selectedSection = event.SectionID;
        $scope.lecture.selectedSectionNum = event.SectionNum;
        $scope.lecture.selectedInstructor = event.InstructorID;
    ...
    $scope.alertOnDrop = function (event, delta, revertFunc, jsEvent, ui, view) {
        ...
        $http.get("WebServices/LectureNewUpdate.ashx", { params: $scope.lecture }).then(function (response) {
