<%@ Page Title="" Language="C#" MasterPageFile="~/StudyTable2/MasterPage.master" AutoEventWireup="true" CodeFile="StudyTableProgram.aspx.cs" Inherits="StudyTable2_StudyTableProgram" %>
                ...
                <div class="portlet-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1_2">
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <asp:DropDownList ID="ddlInstructors" runat="server" CssClass="form-control select2" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="ID" ng-model="instructorid" ng-change="changeInstructor(instructorid)"></asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:isra2 %>" SelectCommand="SELECT ID, [HumanResources].[dbo].[GetEmployeeName](ID,3) as Name FROM [Employee] WHERE ([IsActive] = 1) AND ([IsDelete] = 0) union select -1, N'إختر المحاضر'"></asp:SqlDataSource>
                                </div>
                                <div class="col-md-6 col-sm-12" style="text-align: left">
                            ...
                            <div class="form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control select2" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="ID" ng-model="lecture.selectedInstructor"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">قاعة :</label>
                                        <div class="col-md-8">
                                            <select class="form-control select2" ng-model="lecture.selectedRoom">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <asp:DropDownList ID="ddlDayID" runat="server" CssClass="form-control" DataSourceID="SqlDataSource4" DataTextField="ArName" DataValueField="ID" ng-model="lecture.selectedDay" ng-change="getAvailableRooms()"></asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="من" style="text-align: center;" ng-model="lecture.selectedFromHour" ng-change="getAvailableRooms()" />
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="الي" style="text-align: center;" ng-model="lecture.selectedToHour" ng-change="getAvailableRooms()" />
                                        </div>
                                    </div>
                                </div>
                            </div>
