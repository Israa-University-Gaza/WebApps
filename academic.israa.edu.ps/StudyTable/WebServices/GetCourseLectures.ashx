<%@ WebHandler Language="C#" Class="GetCourseLectures" %>
...
public class GetCourseLectures : IHttpHandler
{

    public void ProcessRequest(HttpContext context)
    {
        System.Web.Script.Serialization.JavaScriptSerializer oSerializer = new System.Web.Script.Serialization.JavaScriptSerializer();
        string sJSON = oSerializer.Serialize(GetMyEvents(context.Request.QueryString["courseid"]));
    ...
    public List<Event> GetMyEvents(string courseid)
    {
        List<Event> events = new List<Event>();
        DataTable DT = DataAccess.GetCourseLectures(courseid, Config.SemesterID);
