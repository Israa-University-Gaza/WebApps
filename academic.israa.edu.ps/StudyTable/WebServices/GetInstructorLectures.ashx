<%@ WebHandler Language="C#" Class="GetInstructorLectures" %>
...
public class GetInstructorLectures : IHttpHandler
{

    public void ProcessRequest(HttpContext context)
    {
        System.Web.Script.Serialization.JavaScriptSerializer oSerializer = new System.Web.Script.Serialization.JavaScriptSerializer();
        string sJSON = oSerializer.Serialize(GetMyEvents(context.Request.QueryString["instructorid"]));
    ...
    public List<Event> GetMyEvents(string instructorid)
    {
        ...
        DataTable DT = DataAccess.GetInstructorLectures(instructorid, Config.SemesterID);
