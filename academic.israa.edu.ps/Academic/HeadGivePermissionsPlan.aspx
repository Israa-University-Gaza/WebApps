<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="HeadGivePermissionsPlan.aspx.cs" Inherits="Academic_HeadGivePermissionsPlan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#HeadPlan_2 a').css("background-color", "#575757");
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                                ...
                                                SelectCommand="SELECT * FROM [Action] WHERE  (AGroup='3HeadPlanGroup' or AGroup='PlanCourseGroup')  AND ([IsDelete] = 0) order by AGroup"></asp:SqlDataSource>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
