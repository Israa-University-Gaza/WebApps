<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="StudentAdmissionApp.aspx.cs" Inherits="Academic_StudentAdmissionApp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $('document').ready(function () {
            ...
            $('#AdmissionApp').addClass("active open");
            $('#AdmissionApp_1 a').css("background-color", "#575757");
            $('#AdmissionApp a span.arrow').addClass("open");
        });
    </script>
</asp:Content>
                        ...
                        <ul class="ver-inline-menu tabbable margin-bottom-10 font-ha">
                            <li>
                                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource10">
                                    <ItemTemplate>
                                        <img src="http://10.1.1.43:81/ProfileImages/Student/<%# Eval("StdImage") %>" class="img-responsive" style="width: 100%" alt="" />
                                    </ItemTemplate>
                                </asp:Repeater>
                            ...
                            <li><a data-toggle="tab" href="#tab4"><i class="fa fa-lock"></i>رغبات الطالب</a></li>
                        </ul>
                    </div>
                    <div class="col-md-9">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT  [ID], [ArName] FROM [ConstantDetails] WHERE  ((ConstantID=16) AND ([IsActive] = 1) AND ([IsDelete] = 0)) union Select -1 , N'إختر الحالة الصحية'"></asp:SqlDataSource>
                                                    </div>
                                                    <label class="col-md-2 control-label">الاعاقة</label>
                                                    <div class="col-md-4">
                                                        <asp:RadioButton ID="rbDisabilityOk" runat="server" Text="يوجد" GroupName="Disability" OnCheckedChanged="rbDisability_CheckedChanged" AutoPostBack="true" />
                                                        <asp:RadioButton ID="rbDisabilityNot" runat="server" Text="لا يوجد" GroupName="Disability" Checked="true" OnCheckedChanged="rbDisability_CheckedChanged" AutoPostBack="true" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT  [ID], [ArName] FROM [ConstantDetails] WHERE  ((ConstantID=1) AND ([IsActive] = 1) AND ([IsDelete] = 0)) union Select -1 , N'إختر الجنسية'"></asp:SqlDataSource>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT  [ID], [ArName] FROM [ConstantDetails] WHERE  ((ConstantID=2) AND ([IsActive] = 1) AND ([IsDelete] = 0)) union Select -1 , N'إختر الديانة'"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <ContentTemplate>
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <h4 class="font-ha">رغبات الطالب</h4>
                                                    </div>
                                                    <div class="col-md-9 isra-pl-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <h4 class="font-ha">اعتماد الطالب</h4>
                                                    </div>
                                                    <div class="col-md-9 isra-pl-0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:DropDownList ID="ddlCollege" runat="server" DataSourceID="SqlDataSource14" CssClass="select2_category form-control" DataTextField="ArName" DataValueField="ID" AutoPostBack="true" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged"></asp:DropDownList>
                                                    ...
                                                    <div class="col-md-4">
                                                        <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="select2_category form-control" DataSourceID="SqlDataSource15" DataTextField="ArName" DataValueField="ID" AutoPostBack="true"></asp:DropDownList>
