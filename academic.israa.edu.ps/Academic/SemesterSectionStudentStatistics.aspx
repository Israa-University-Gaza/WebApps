<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterSectionStudentStatistics.aspx.cs" Inherits="Academic_SemesterSectionStudentStatistics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#SemesterSectionStudentStatistics_1 a').css("background-color", "#575757");
    ...
    <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li>
            ...
            <ul role="menu" class="dropdown-menu pull-left">
                <li class="font-ha"><a href="SemesterSectionStudentStatistics.aspx">طلاب الشعب</a></li>
            </ul>
        </li>
    </ul>
</asp:Content>
