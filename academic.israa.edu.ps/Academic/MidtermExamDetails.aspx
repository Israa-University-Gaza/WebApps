<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="MidtermExamDetails.aspx.cs" Inherits="Academic_MidtermExamDetails" %>
                ...
                <div class="portlet-body form">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <asp:Label ID="LabelEmpID" runat="server" Visible="False" Text=""></asp:Label>
                            <div class="col-md-4">
                                <span>الفصل :</span>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>"
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="LabelEmpID" PropertyName="Text" Name="EmployeeID" Type="String" DefaultValue="-1" />
                                    </SelectParameters>
