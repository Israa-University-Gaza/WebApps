<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="CourseBookStatistics2.aspx.cs" Inherits="Academic_CourseBookStatistics2" %>
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <i class="fa fa-reorder"></i>إحصائية المساقات المطروحة وليس لها كتاب مدخل 
                </div>
                <div class="tools">
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 25%; text-align: center;">الكلية</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="CourseBookStatistics2" SelectCommandType="StoredProcedure">
                                <SelectParameters>
