<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="ConfirmAcceptAdmissionApplication.aspx.cs" Inherits="Academic_ConfirmAcceptAdmissionApplication" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#AdmissionApp_3 a').css("background-color", "#575757");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        <li>
            ...
            <a href="Default.aspx" class="font-ha">دائرةالشؤون الاكاديمية</a>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource5">
                                                <ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <%# ((RadioButtonList) Container.FindControl("rblWishes")).SelectedValue = Eval("AdmissionDepartmentID").ToString() %>
                                                        <td style="text-align: center">
                                                            <asp:LinkButton ID="lbAccept" runat="server" class="btn default btn-xs black" OnClick="lbAccept_Click"><i class="fa fa-edit"></i> تأكيد الإعتماد</asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:ListView>
                                            <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                                ConnectionString="<%$ ConnectionStrings:isra %>"
                                                SelectCommand="GetConfirmAdmissionApplication" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                        </tbody>
                                    </table>
                                </div>
