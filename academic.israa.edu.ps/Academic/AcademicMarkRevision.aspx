<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicMarkRevision.aspx.cs" Inherits="Academic_AcademicMarkRevision" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#AcademicMarkRevision').addClass("active open");
        });
    </script>
</asp:Content>
