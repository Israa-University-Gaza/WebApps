<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicCourse.aspx.cs" Inherits="Academic_AcademicCourse" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="row">
        <% if (Permissions.Contains("AcademicCourseAdd") || Permissions.Contains("AcademicCourseEdit"))
           { %>
        <div class="col-md-12">
                    ...
                    <div class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList ID="ddlCollege" runat="server" DataSourceID="SqlDataSource2" DataTextField="ArName" DataValueField="ID" AutoPostBack="true" CssClass="select2_category form-control"></asp:DropDownList>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT ID, ArName FROM [Department] WHERE (([IsActive] = 1) AND ([IsDelete] = 0) AND ([CollegeID] in (Select ID From College Where ID=@CollegeID))) union select -1,N'إختر التخصص'">
                                        <SelectParameters>
        ...
        <% } %>
        <% if (Permissions.Contains("AcademicCourseView"))
           { %>
        <div class="col-md-12">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                                <ItemTemplate>
                                    ...
                                    <tr <%# (lblCourseID.Text==Eval("ID").ToString())?"style='background-color:#F5F5F5'":"" %>>
                                        ...
                                        <td style="text-align: center">
                                            <asp:CheckBox ID="cbIsActive" runat="server" AutoPostBack="true" OnCheckedChanged="cbIsActive_CheckedChanged" Checked='<%# Eval("IsActive") %>' Enabled='<%# (Permissions.Contains("AcademicCourseActivate"))? true:false %>' /></td>
                                        <td style="text-align: center">
                                            ...
                                            <% } %>
                                            <% if (Permissions.Contains("AcademicCourseDelete"))
                                               { %>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="SELECT *,(Select ArName From [Department] Where ID=DepartmentID) as Department FROM [Course] where [IsDelete]=0 order by [ID] DESC"></asp:SqlDataSource>
                        </tbody>
                    </table>
