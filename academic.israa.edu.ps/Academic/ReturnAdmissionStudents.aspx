<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="ReturnAdmissionStudents.aspx.cs" Inherits="Academic_ReturnAdmissionStudents" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#Student_3 a').css("background-color", "#575757");
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>الطلاب المرجعين من القبول والتسجيل</div>
                    <div class="tools">
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <asp:LinkButton ID="lbAcceptReturnStudent" runat="server" class="btn default btn-xs black" OnClick="lbAcceptReturnStudent_Click">قبول الإرجاع</asp:LinkButton>
                                                    <asp:LinkButton ID="lbRejectReturnStudent" runat="server" class="btn default btn-xs black" OnClick="lbRejectReturnStudent_Click">رفض الإرجاع</asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:ListView>
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                        ...
                                        SelectCommand="GetReturnAdmissionStudents" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                </tbody>
                            </table>
                            ...
                            <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                                <div class="col-xs-11" style="text-align: center">
                                    <strong>لا يوجد طلاب مرجعين</strong>
