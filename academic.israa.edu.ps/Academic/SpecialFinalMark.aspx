<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="SpecialFinalMark.aspx.cs" Inherits="Academic_SpecialFinalMark" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#SpecialFinalMark').addClass("active open");
        });
    </script>
</asp:Content>
    ...
    <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li>
            <button data-close-others="true" data-delay="1000" data-hover="dropdown" data-toggle="dropdown" class="btn font-ha dropdown-toggle" style="padding: 0px!important; background-color: #FAFAFA!important;" type="button">
                <span>علامات الطلاب المكتبي والصيفي الخاص </span><i class="fa fa-angle-down"></i>
            </button>
        </li>
    </ul>
</asp:Content>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                    ...
                                    SelectCommand="GetStudentsSpecialMarks" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
