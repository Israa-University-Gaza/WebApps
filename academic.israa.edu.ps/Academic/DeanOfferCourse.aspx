<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="DeanOfferCourse.aspx.cs" Inherits="Academic_DeanOfferCourse" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#DeanOffer_1 a').css("background-color", "#575757");
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT top 1 ID, ArName FROM [Semester] WHERE (([Code] <> '111111111') AND ([IsActive] = 1) AND ([IsDelete] = 0) AND (ProgramID=@ProgramID)) ORDER BY ID DESC">
                                        <SelectParameters>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="GetDepartmentByDean" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
