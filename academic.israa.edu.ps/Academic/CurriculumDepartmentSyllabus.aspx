<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="CurriculumDepartmentSyllabus.aspx.cs" Inherits="Academic_CurriculumDepartmentSyllabus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#Syllabus_4 a').css("background-color", "#575757");
