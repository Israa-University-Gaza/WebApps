<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicSectionStudentsMarks.aspx.cs" Inherits="Academic_AcademicSectionStudentsMarks" %>
                                ...
                                <div id="tab1" class="tab-pane active">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <% bool MarkIsAccreditation = (DataAccess.MarkIsAccreditation(ddlSection.SelectedValue, 3).Rows[0]["status"].ToString() == "1"); %>
                                            <% if (MarkIsAccreditation)
                                                { %>
                                            <div class="row">
                                                    ...
                                                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource3">
                                                        <ItemTemplate>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <strong>المحاضر : </strong><span><%# Eval("Employee") %></span>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4" style="text-align: center;">
                                                                ...
                                                                <br />
                                                                <asp:Button ID="btnMarkAllAccreditation" runat="server" Text='<%# (Eval("IsAllAccreditation").ToString()=="0") ? "إعتماد العلامات":"تم إعتماد العلامات" %>' CssClass="btn green" Enabled='<%# (Eval("IsAllAccreditation").ToString()=="0") ? true:false %>' OnClick="btnMarkAllAccreditation_Click" OnClientClick="return confirm('هل أنت متأكد من أنك تود إعتماد العلامات ؟');" />
                                                                <asp:Button ID="btnMarkAllUnaccreditation" runat="server" Text='<%# (Eval("IsExistAccreditation").ToString()=="1") ? "إرجاع العلامات":"لا يوجد معتمد" %>' CssClass="btn green" Enabled='<%# (Eval("IsExistAccreditation").ToString()=="1") ? true:false %>' OnClick="btnMarkAllUnaccreditation_Click" OnClientClick="return confirm('هل أنت متأكد من أنك تود إرجاع العلامات ؟');" />
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                                        ...
                                                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource5">
                                                            <ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center; font-size: 12px; padding: 10px;"><span><%# (Convert.ToBoolean(Eval("IsMidtermIncomplete").ToString())) ? "غير مكتمل": ((Convert.ToBoolean(Eval("IsMidtermNoMark").ToString())) ? "غياب" : Eval("MidtermMark")) %></span></td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="btnMarkAccreditation" runat="server" Text="اعتماد" CssClass="btn green" Visible='<%# (Convert.ToBoolean(Eval("DeanAccreditation").ToString()) && !Convert.ToBoolean(Eval("AcademicAccreditation").ToString())) ? true:false %>' OnClick="btnMarkAccreditation_Click" OnClientClick="return confirm('هل أنت متأكد من أنك تود إعتماد علامة الطالب ؟');" />
                                                                        <asp:Button ID="btnMarkUnaccreditation" runat="server" Text="ارجاع" CssClass="btn green" Visible='<%# (Convert.ToBoolean(Eval("AcademicAccreditation").ToString())) ? true:false %>' OnClick="btnMarkUnaccreditation_Click" OnClientClick="return confirm('هل أنت متأكد من أنك تود إلغاء إعتماد علامة الطالب ؟');" />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:ListView>
                                            ...
                                            <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                                                <div class="col-xs-11" style="text-align: center">
                                                    <strong>لم يتم إعتماد العلامات من قبل عميد الكلية بعد</strong>
                                                    <div style="clear: both"></div>
                                                </div>
                                                <button type="button" style="margin-top: 4px;" class="close col-xs-2" data-dismiss="alert" aria-hidden="true"></button>
                                                <div style="clear: both"></div>
