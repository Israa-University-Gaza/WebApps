<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicMidtermMarkRevision.aspx.cs" Inherits="Academic_AcademicMarkRevision" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#AcademicMidtermMarkRevision').addClass("active open");
        });
    </script>
</asp:Content>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 6%; text-align: center">محاضر</th>
                                    <th scope="col" style="width: 6%; text-align: center">عميد</th>
                                    <th scope="col" style="width: 8%; text-align: center">نائب أكاديمي</th>
                                    <th scope="col" style="width: 12%; text-align: center">العلامة</th>
                            ...
                            <tbody>
                                <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource5">
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; font-size: 12px; padding: 10px;">
                                                <span><%# Eval("MidtermMark") %></span>
                                                <br />
                                                <span><%# Eval("NewMidtermMark") %></span>
                                            </td>
                                            <td>
                                                <asp:Button ID="btnAcceptRequest" runat="server" Text="إعتماد" CssClass="btn green" Style="height: 26px; padding: 0 15px" OnClick="btnAcceptRequest_Click" Visible='<%#(Convert.ToBoolean(Eval("IsAcceptRequest").ToString()) && Convert.ToBoolean(Eval("IsDeanAccept").ToString()) && !Convert.ToBoolean(Eval("IsAcademicAccept").ToString()) && !Convert.ToBoolean(Eval("IsAcademicReject").ToString())) ? true : false %>' />
                                                <asp:Button ID="btnRejectRequest" runat="server" Text="رفض الطلب" CssClass="btn default" Style="height: 26px; padding: 0 15px" OnClick="btnRejectRequest_Click" Visible='<%#(Convert.ToBoolean(Eval("IsAcceptRequest").ToString()) && Convert.ToBoolean(Eval("IsDeanAccept").ToString()) && !Convert.ToBoolean(Eval("IsAcademicAccept").ToString()) && !Convert.ToBoolean(Eval("IsAcademicReject").ToString())) ? true : false %>' />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:ListView>
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server"
                                    ...
                                    SelectCommand="GetMidtermMarkRevision" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
