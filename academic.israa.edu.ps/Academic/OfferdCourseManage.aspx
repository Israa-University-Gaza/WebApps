<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="OfferdCourseManage.aspx.cs" Inherits="Academic_OfferdCourseManage" %>
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="SELECT ID, ArName FROM [Semester] Where ID=9"></asp:SqlDataSource>
                        </div>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><%# (Eval("Gender").ToString()=="1")? "طلاب" :((Eval("Gender").ToString()=="2")? "طالبات" : "مشترك")  %></td>
                                            <td style="text-align: center;">
