<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="SyllabusActivities.aspx.cs" Inherits="SyllabusActivities" %>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 43%; text-align: left">النشاط التعليمي بالانجليزية</th>
                        ...
                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="lbSyllabusActivityEdit" runat="server" CssClass="btn default btn-xs green" OnClick="lbSyllabusActivityEdit_Click" Visible='<%# ( (Eval("CanDepartmentEdit").ToString() == "1")) ? true:false %>'> <i class="fa fa-edit"></i> تحرير</asp:LinkButton>
                                        <asp:LinkButton ID="lbSyllabusActivityDelete" runat="server" CssClass="btn default btn-xs purple" OnClick="lbSyllabusActivityDelete_Click" Visible='<%# ( (Eval("CanDepartmentEdit").ToString() == "1")) ? true:false %>' OnClientClick="return confirm('هل انت متاكد من عملية الحذف؟')"><i class="fa fa-trash-o"></i> حذف</a></asp:LinkButton>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:ListView>
                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:isra %>' SelectCommand="GetSyllabusActivity" SelectCommandType="StoredProcedure">
                            <SelectParameters>
