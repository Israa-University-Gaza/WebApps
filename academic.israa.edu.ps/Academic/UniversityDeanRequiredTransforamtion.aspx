<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="UniversityDeanRequiredTransforamtion.aspx.cs" Inherits="Academic_UniversityDeanRequiredTransforamtion" %>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ...
                                    SelectCommand="GetUniversityDeanStudentWithoutTransformation" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                            </tbody>
                        </table>
