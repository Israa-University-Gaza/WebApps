<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="DeanStudents.aspx.cs" Inherits="Academic_DeanStudents" %>
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>طلاب الكلية</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlDepartment" runat="server" class="form-control" DataTextField="ArName" DataValueField="ID" DataSourceID="SqlDataSource1"></asp:DropDownList>
                        ...
                        <label class="control-label col-md-2" style="text-align: left;">نوع الطالب :</label>
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlStudentType" runat="server" class="form-control" DataTextField="ArName" DataValueField="ID" DataSourceID="SqlDataSource2"></asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                ConnectionString="<%$ ConnectionStrings:isra %>"
                                SelectCommand="Select * From StudentTypes Where IsDelete=0"></asp:SqlDataSource>
                        </div>
                    </div>
                    <div class="form-group row">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource4">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <th style="text-align: center;"><%# Eval("RowNo") %></th>
                                                ...
                                                <td style="text-align: center;">
                                                    <asp:LinkButton ID="lbOpenStudent" runat="server" class="btn default btn-xs black" OnClick="lbOpenStudent_Click"><i class="fa fa-edit"></i> دخول</asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:ListView>
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:isra %>"
                                        SelectCommand="GetDeanStudents" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
