<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="CourseBookRequestUnAccreditStatistics2.aspx.cs" Inherits="Academic_CourseBookRequestUnAccreditStatistics2" %>
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i>إحصائية المساقات المطروحة التي لها طلبات كتب و غير معتمد كتبها من الكلية
                </div>
                <div class="tools">
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%; text-align: center;">اسم الكتاب</th>
