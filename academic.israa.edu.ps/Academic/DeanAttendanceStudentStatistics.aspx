<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="DeanAttendanceStudentStatistics.aspx.cs" Inherits="Academic_DeanAttendanceStudentStatistics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#AttendanceStudentStatistics').addClass("active open");
