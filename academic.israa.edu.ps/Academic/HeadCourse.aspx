<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="HeadCourse.aspx.cs" Inherits="Academic_HeadCourse" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#menu2_6 a').css("background-color", "#575757");
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="row">
        <% if (Permissions.Contains("HeadCourseAdd") || Permissions.Contains("HeadCourseEdit"))
           { %>
        <div class="col-md-12">
        ...
        <% } %>
        <% if (Permissions.Contains("HeadCourseView"))
           { %>
        <div class="col-md-12">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
                                <ItemTemplate>
                                    ...
                                    <tr <%# (lblCourseID.Text==Eval("ID").ToString())?"style='background-color:#F5F5F5'":"" %>>
                                        ...
                                        <td style="text-align: center">
                                            <asp:CheckBox ID="cbIsActive" runat="server" AutoPostBack="true" OnCheckedChanged="cbIsActive_CheckedChanged" Checked='<%# Eval("IsActive") %>' Enabled='<%# (Permissions.Contains("HeadCourseActivate"))? true:false %>' /></td>
                                        <td style="text-align: center">
                                            <% if (Permissions.Contains("HeadCourseEdit"))
                                               { %>
                                            ...
                                            <% } %>
                                            <% if (Permissions.Contains("HeadCourseDelete"))
                                               { %>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="GetCourseByHead" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="lblEmployeeID" PropertyName="Text" Name="EmployeeID" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
