...
public partial class Academic_StudentAdmissionApp : UserPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["StdID"] != null)
                ...
                Response.Redirect("~/Academic/ShowAdmissionApplication.aspx");
    ...
    protected void rbDisability_CheckedChanged(object sender, EventArgs e)
    {
        Disability.Visible = rbDisabilityOk.Checked;
        RunJQuery();
    }
