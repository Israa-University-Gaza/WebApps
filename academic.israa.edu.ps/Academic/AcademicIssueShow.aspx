<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicIssueShow.aspx.cs" Inherits="AcademicIssueShow" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#StudentIssue_2 a').css("background-color", "#575757");
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box blue">
          ...
          <asp:ListItem Value="16">محول من كلية</asp:ListItem>
                        ...
                        <tbody>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:UniversityStudentIssues %>' SelectCommand="IssuesShow" SelectCommandType="StoredProcedure">
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:Parameter DefaultValue="3" Name="Place" Type="Int32"></asp:Parameter>
