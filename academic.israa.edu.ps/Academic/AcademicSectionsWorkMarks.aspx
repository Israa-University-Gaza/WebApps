<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="AcademicSectionsWorkMarks.aspx.cs" Inherits="Academic_AcademicSectionsWorkMarks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#AcademicSectionsWorkMarks_1 a').css("background-color", "#575757");
            $('#AcademicSectionsWorkMarks_1 a span.arrow').addClass("open");
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="GetEmployeePrograms_1" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="GetEmployeeCollages_1" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="lblEmployeeID" PropertyName="Text" Name="EmployeeID" Type="Int32"></asp:ControlParameter>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="GetEmployeeDepartments_1" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <% if (IsPermissionsContains("AcademicSectionStudentsMarks"))
                                                { %>
                                            <asp:Button ID="btnWorkMarkAcademicAccreditation" runat="server" Text='<%# (Convert.ToBoolean(Eval("AcademicAccreditation").ToString())==false)? "إعتماد أكاديمي":"تم إعتماد العلامات" %>' CssClass="btn green" Enabled='<%# (Convert.ToBoolean(Eval("AcademicAccreditation").ToString())==false)  && (Convert.ToBoolean(Eval("DeanAccreditation").ToString())==true)   ? true:false %>' OnClick="btnWorkMarkAcademicAccreditation_Click" OnClientClick="return confirm('هل أنت متأكد من أنك تود إعتماد العلامات ؟');" />
                                            <%} %>
                                        </td>
                                    </tr>
                                </ItemTemplate>
