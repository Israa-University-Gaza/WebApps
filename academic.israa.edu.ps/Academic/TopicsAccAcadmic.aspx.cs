   ...
   
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        row = row - 1;
        DropDownList Acadmicacc1 = (DropDownList)GridView2.Rows[row].FindControl("Acadmicacc1");
        TextBox AcadmicComment = (TextBox)GridView2.Rows[row].FindControl("AcadmicComment");
        ...
        cmd.Parameters.Add(new SqlParameter("@comment", AcadmicComment.Text));
        cmd.Parameters.Add(new SqlParameter("@Accerdation ", Acadmicacc1.SelectedValue));
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (DataBinder.Eval(e.Row.DataItem, "std_id") != null)
        {
            ...
            {
                DropDownList Acadmicacc = (DropDownList)e.Row.FindControl("Acadmicacc");
                TextBox AcadmicComment = (TextBox)e.Row.FindControl("AcadmicComment");


                if (Convert.ToBoolean(DT3.Rows[0]["Acadmicacc"]))
                    Acadmicacc.SelectedValue = "1";
                else
                    Acadmicacc.SelectedValue = "0";

                AcadmicComment.Text = DT3.Rows[0]["StudentAffComment"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        int row = Convert.ToInt32(Button1.CommandArgument);
        row = row - 1;
        DropDownList Acadmicacc = (DropDownList)GridView1.Rows[row].FindControl("Acadmicacc");
        TextBox AcadmicComment = (TextBox)GridView1.Rows[row].FindControl("AcadmicComment");
        ...
        cmd.Parameters.Add(new SqlParameter("@ID", HiddenField1.Value));
        cmd.Parameters.Add(new SqlParameter("@comment ", AcadmicComment.Text));
        cmd.Parameters.Add(new SqlParameter("@Accerdation ", Acadmicacc.SelectedValue));
        cmd.Parameters.Add(new SqlParameter("@AccerdationEmployeeID ", Context.User.Identity.Name.ToString()));
        cmd.Parameters.Add(new SqlParameter("@type", 3));
...
mangmentAcc.Text = "معلقة"; mangmentComment1.Text = "معلقة";
            ...
            if (DT3.Rows[0]["Acadmicacc"].ToString() != "")

            {
                DropDownList Acadmicacc1 = (DropDownList)e.Row.FindControl("Acadmicacc1");
                TextBox AcadmicComment = (TextBox)e.Row.FindControl("AcadmicComment");


                if (Convert.ToBoolean(DT3.Rows[0]["Acadmicacc"]))
                    Acadmicacc1.SelectedValue = "1";
                else
                    Acadmicacc1.SelectedValue = "0";

                AcadmicComment.Text = DT3.Rows[0]["AcadmicComment"].ToString();
