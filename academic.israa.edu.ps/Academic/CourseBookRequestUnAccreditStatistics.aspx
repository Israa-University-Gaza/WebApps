<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="CourseBookRequestUnAccreditStatistics.aspx.cs" Inherits="Academic_CourseBookRequestUnAccreditStatistics" %>
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i>إحصائية المساقات الغير معتمد كتبها من الكلية
                </div>
                <div class="tools">
