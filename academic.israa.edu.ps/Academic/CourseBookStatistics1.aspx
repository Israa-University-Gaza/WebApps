<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="CourseBookStatistics1.aspx.cs" Inherits="Academic_CourseBookStatistics1" %>
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <i class="fa fa-reorder"></i>إحصائية المساقات المطروحة ولها كتاب مدخل 
                </div>
                <div class="tools">
                ...
                <div class="form-body">
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        ...
                        <tbody>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="CourseBookStatistics1" SelectCommandType="StoredProcedure">
                                <SelectParameters>
