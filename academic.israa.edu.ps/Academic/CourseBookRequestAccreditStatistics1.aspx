<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master" AutoEventWireup="true" CodeFile="CourseBookRequestAccreditStatistics1.aspx.cs" Inherits="Academic_CourseBookRequestAccreditStatistics1" %>
    ...
    <div class="col-md-12 ">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i>إحصائية المساقات المطروحة التي لها طلب كتاب ولها كتاب مدخل معتمد
                </div>
                <div class="tools">
                ...
                <div class="form-body">
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        ...
                        <tbody>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString="<%$ ConnectionStrings:isra %>" SelectCommand="AccreditBookOfCourseBookRequestStatistics1" SelectCommandType="StoredProcedure">
                                <SelectParameters>
