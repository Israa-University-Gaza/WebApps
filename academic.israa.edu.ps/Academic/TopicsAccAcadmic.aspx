<%@ Page Title="" Language="C#" MasterPageFile="~/Academic/MasterPage.master"  AutoEventWireup="true" CodeFile="TopicsAccAcadmic.aspx.cs" Inherits="Academic_Topics" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-cogs"></i> المواضيع (الشؤون الأكاديمية) </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="ID" DataSourceID="SqlDataSource1" EmptyDataText="لا يوجد بيانات لعرضها" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label>الإعتماد:  </label>
                                                           <asp:DropDownList ID="Acadmicacc" CssClass="form-control" runat="server">
                    ...
                    <asp:ListItem Value="0">رفض</asp:ListItem>
                                                        ...
                                                        <div class="form-group">
                                                        <label>راي الشؤون الأكاديمية:  </label>
                                                            <asp:TextBox ID="AcadmicComment"  CssClass="form-control" TextMode="MultiLine"  runat="server"></asp:TextBox>
	...
	ORDER BY id
   ) row_num,* FROM [Topics] WHERE (([IsActive] = @IsActive) AND ([IsFinish] = @IsFinish) and StudentAffAccerdationEmployeeID is  not null and AcadmicAccerdationEmployeeID is null)">
                    <SelectParameters>
                                                ...
                                                <div style="text-align: right;font-family: revert">
                                                   ...
                                                   <div class="row"> 
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label>الإعتماد:  </label>
                                                           <asp:DropDownList ID="Acadmicacc1" CssClass="form-control" runat="server">
<%--                                                                <asp:ListItem Value="-1">اختر</asp:ListItem>--%>
                    <asp:ListItem Value="1">موافقة</asp:ListItem>
                    <asp:ListItem Value="0">رفض</asp:ListItem>
                                                           </asp:DropDownList>
                                                        ...
                                                        <div class="form-group">
                                                        <label>راي الشؤون الاكاديمية:  </label>
                                                            <asp:TextBox ID="AcadmicComment"  CssClass="form-control" TextMode="MultiLine"  runat="server"></asp:TextBox>
                                                           <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DeptComment" ErrorMessage="اختر" ForeColor="Red" InitialValue="-1" SetFocusOnError="True"></asp:RequiredFieldValidator>--%>
                                                        &nbsp;
                                                            <asp:HiddenField ID="HiddenField1" Value='<%# Bind("id") %>' runat="server" />
	...
	ORDER BY id
   ) row_num,* FROM [Topics] WHERE (([IsActive] = @IsActive) AND ([IsFinish] = @IsFinish) and AcadmicAccerdationEmployeeID is not null)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="True" Name="IsActive" Type="Boolean" />
                        <asp:Parameter DefaultValue="False" Name="IsFinish" Type="Boolean" />
                    </SelectParameters>
