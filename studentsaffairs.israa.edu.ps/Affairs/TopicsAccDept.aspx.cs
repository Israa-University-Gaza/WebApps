...
public partial class Affairs_Topics : System.Web.UI.Page
{
    ...
    {
        if (Context.User.Identity.Name.ToString() != "5124" && Context.User.Identity.Name.ToString() != "5267")
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        row = row - 1;
        DropDownList Deptacc = (DropDownList)GridView2.Rows[row].FindControl("Deptacc");
        TextBox DeptComment = (TextBox)GridView2.Rows[row].FindControl("DeptComment");
        ...
        cmd.Parameters.Add(new SqlParameter("@comment", DeptComment.Text));
        cmd.Parameters.Add(new SqlParameter("@Accerdation ", Deptacc.SelectedValue));
    ...
    protected void Btn_del_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["IsraaStudentIssue"] + "");
        SqlCommand cmd = new SqlCommand("Topics_delete", conn);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (DataBinder.Eval(e.Row.DataItem, "std_id") != null)
        {
            ...
            DA3.Fill(DT3);
            DropDownList Deptacc = (DropDownList)e.Row.FindControl("Deptacc");
                TextBox DeptComment = (TextBox)e.Row.FindControl("DeptComment");
            if (DT3.Rows[0]["Deptacc"].ToString() != "")

            {
                ...
                DeptComment.Text = DT3.Rows[0]["DeptComment"].ToString();
              ...
              SqlDataAdapter DA33 = new SqlDataAdapter("select StudentAffAccdate from topics where id=" + HiddenField1.Value, conn1);
                ...
                DA33.Fill(DT33);
                if (DT33.Rows[0]["StudentAffAccdate"].ToString() != "")
                {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        int row = Convert.ToInt32(Button1.CommandArgument);
        row = row - 1;
        DropDownList Deptacc = (DropDownList)GridView1.Rows[row].FindControl("Deptacc");
        TextBox DeptComment = (TextBox)GridView1.Rows[row].FindControl("DeptComment");
        ...
        cmd.Parameters.Add(new SqlParameter("@comment", DeptComment.Text));
        cmd.Parameters.Add(new SqlParameter("@Accerdation ", Deptacc.SelectedValue));
        cmd.Parameters.Add(new SqlParameter("@AccerdationEmployeeID ", ""));
        cmd.Parameters.Add(new SqlParameter("@type", 1));
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (DataBinder.Eval(e.Row.DataItem, "std_id") != null)
        {
            ...
            Label stdNo = (Label)e.Row.FindControl("stdNo");
            Label stdName = (Label)e.Row.FindControl("stdName");
           Button   btn_fin=(Button) e.Row.FindControl("btn_fin");
...
StudentAff.Text = "معلقة"; StudentAffComment1.Text = "معلقة"; StudentAff.Enabled = false;
            ...
            else
            {
                ...
                {
mangmentAcc.Text = "معلقة"; mangmentComment1.Text = "معلقة"; btn_fin.Visible = false;
...
DropDownList Deptacc = (DropDownList)e.Row.FindControl("Deptacc");
 ...
 SqlDataAdapter DA33 = new SqlDataAdapter("select StudentAffAccdate from topics where id=" + HiddenField1.Value, conn1);
    ...
    {
        Button btn_fin = (Button)sender;
        string id = btn_fin.CommandArgument;

        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["IsraaStudentIssue"] + "");
        SqlCommand cmd = new SqlCommand("FinishTopics", conn);
        cmd.Parameters.Add(new SqlParameter("@ID", id));
