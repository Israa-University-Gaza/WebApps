<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="StudentSocialSolidarity.aspx.cs" Inherits="StudentInstallmentAddEdit" %>
                ...
                <div class="row">
                    ...
                    <div style="width: 81%; float: right;">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="col-md-2">قيمة التكافل بالدينار : </label>
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtSocialSolidarityValue" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-offset-2 col-md-3">
                                        <asp:Button ID="btnSocialSolidarityAdd" runat="server" CssClass="btn blue btn btn-rounded default btn-block" OnClick="btnSocialSolidarityAdd_Click" Text="إضافة قيمة التكافل الإجتماعي" />
                                    </div>
                                </div>
                            </div>
                        </div>
