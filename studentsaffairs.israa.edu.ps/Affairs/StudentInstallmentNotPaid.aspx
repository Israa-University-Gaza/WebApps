<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="StudentInstallmentNotPaid.aspx.cs" Inherits="Affairs_StudentInstallmentNotPaid" %>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>كشف الأقساط الغير مسددة خلال فنرة محددة</div>
                    <div class="tools">
