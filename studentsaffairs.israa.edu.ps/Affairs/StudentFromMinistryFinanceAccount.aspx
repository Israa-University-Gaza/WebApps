<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="StudentFromMinistryFinanceAccount.aspx.cs" Inherits="Affairs_StudentFromMinistryFinanceAccount" %>
    ...
    <ul class="page-breadcrumb breadcrumb isra-contaner-heder">
        ...
        <li>
            <button data-close-others="true" data-delay="1000" data-hover="dropdown" data-toggle="dropdown" class="btn font-ha dropdown-toggle" style="padding: 0px!important; background-color: #FAFAFA!important;" type="button">
                <span>طلاب الخصومات من المستحقات</span> <i class="fa fa-angle-down"></i>
            </button>
        </li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>طلاب الخصومات من مستحقات موظفي غزة</div>
                    <div class="tools">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center; width: 10%">القيمة بالدينار</th>
                                        <th style="text-align: center; width: 10%">القيمة بالشيكل</th>
                                    ...
                                    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource4">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><%# Eval("ValueJOD") %></td>
                                                <td style="text-align: center;"><%# Eval("ValueNIS") %></td>
                                                <td style="text-align: center;">
                                                    <span class='<%# Convert.ToInt32(Eval("IsTransition")) == 1 ? "label label-success" : "label label-danger" %>'><%# Convert.ToInt32(Eval("IsTransition")) == 1 ? "معتمد" : "غير معتمد" %></span>
