<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="TopicsAccMangment.aspx.cs" Inherits="Affairs_Topics" %>
            ...
            <div class="portlet-body">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="ID" DataSourceID="SqlDataSource2" EmptyDataText="لا يوجد بيانات لعرضها" OnRowDataBound="GridView2_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                &nbsp; &nbsp;<asp:Button ID="Button122" runat="server" CssClass="btn-warning" Text="معاينة" data-toggle="modal" href='<%# "#basic1"+Eval("id") %>' />

                                <div class="modal fade" id='<%# "basic1"+Eval("id") %>' tabindex="-1" role="basic" aria-hidden="true">
                                    <div class="modal-dialog" style=" width: 804px;">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                ...
                                                <div style="text-align: right;font-family: revert">
                                                   ...
                                                   <div class="row"> 
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label>الإعتماد:  </label>
                                                           <asp:DropDownList ID="mangmentAcc" CssClass="form-control" runat="server">
<%--                                                                <asp:ListItem Value="-1">اختر</asp:ListItem>--%>
                    <asp:ListItem Value="1">موافقة</asp:ListItem>
                    <asp:ListItem Value="0">رفض</asp:ListItem>
                                                           </asp:DropDownList>
