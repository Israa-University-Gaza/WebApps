<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterStudentsInstallments2.aspx.cs" Inherits="Affairs_SemesterStudentsInstallments2" %>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                            ...
                                            <SelectParameters>
                                                <%--<asp:ControlParameter ControlID="ddlSemester" PropertyName="SelectedValue" Name="SemesterID" Type="Int32" />--%>
                                                <asp:Parameter DefaultValue="5" Name="SemesterID" Type="Int32" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                                    </tbody>
                                </table>
