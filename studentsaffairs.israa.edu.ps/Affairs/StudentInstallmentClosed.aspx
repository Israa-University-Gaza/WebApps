<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="StudentInstallmentClosed.aspx.cs" Inherits="Affairs_StudentInstallmentClosed" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $('document').ready(function () {
            ...
            $('#StudentInstallmentClosed').addClass("active open");
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">كشف الأقساط الغير مسددة خلال فنرة محددة</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>كشف الأقساط الموقوفة خلال فنرة محددة</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:TextBox ID="txtDateFrom" runat="server" CssClass="form-control date-picker" Text="2016/09/03"></asp:TextBox>
                        </div>
                        <label class="col-md-1 control-label">الى تاريخ</label>
                        <div class="col-md-2">
                            <asp:TextBox ID="txtDateTo" runat="server" CssClass="form-control date-picker" Text="2017/05/30"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="GetStudentInstallmentClosed" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                    ...
                    <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                        <div class="col-xs-11" style="text-align: center">
                            <strong>لا يوجد أقساط موقوفة خلال الفترة المحددة</strong>
