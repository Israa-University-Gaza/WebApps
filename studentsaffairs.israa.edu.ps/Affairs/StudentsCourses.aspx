<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="StudentsCourses.aspx.cs" Inherits="Affairs_StudentsCourses" %>
                    ...
                    <table class="table table-striped table-hover" id="sample_editable_1 ">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%; text-align: center">عدد الطلبات</th>
                                <th style="width: 15%; text-align: center">اجمالي عدد الساعات</th>
                                <th style="width: 20%; text-align: center">اجمالي التكلفة بالدينار</th>
                            </tr>
                        </thead>
                        <tbody>
