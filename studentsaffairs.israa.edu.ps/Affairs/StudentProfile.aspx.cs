...
public partial class Affairs_StudentProfile : UserPage
{
            ...
            if (Session["StudentID"] != null)
            {
                ...
                if (DT.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        x.Visible = true; xx.Visible = true; xxx.Visible = true; 
                        //xxxx.Visible = true;
    ...
    //        if (Validate && IntValidate)
    //        {
    //            if (DataAccess.StudentTawjehyDataAddEdit(lblStudentID.Text,txtOldUniversity.Text, txtOldDepartment.Text,txtOldUniversityHours.Text, txtOldUniversityGPA.Text, txtShamelRate.Text, txtExpertYears.Text) > 0)
    //            {
