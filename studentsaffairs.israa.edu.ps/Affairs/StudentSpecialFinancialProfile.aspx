<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="StudentSpecialFinancialProfile.cs" Inherits="Affairs_StudentSpecialFinancialProfile" %>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center;">
                                                                ...
                                                                <asp:LinkButton ID="lbActionArName" Visible="false" runat="server" OnClick="lbActionArName_Click">   <%# Eval("ActionArName") %></asp:LinkButton>
                                                                <asp:Label ID="lblActionArName" runat="server" Visible="true" Text=' <%# Eval("ActionArName") %>'></asp:Label>
