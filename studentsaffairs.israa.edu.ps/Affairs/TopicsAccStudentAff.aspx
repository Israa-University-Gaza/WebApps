<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="TopicsAccStudentAff.aspx.cs" Inherits="Affairs_Topics" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="col-md-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-cogs"></i> المواضيع (مدير دائرة شؤون الطلبة) </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="ID" DataSourceID="SqlDataSource1" EmptyDataText="لا يوجد بيانات لعرضها" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label>الإعتماد:  </label>
                                                           <asp:DropDownList ID="StudentAffAcc" CssClass="form-control" runat="server">
                    ...
                    <asp:ListItem Value="0">رفض</asp:ListItem>
                                                        ...
                                                        <div class="form-group">
                                                        <label>راي مدير دائرة شؤون الطلبة:  </label>
                                                            <asp:TextBox ID="StudentAffComment"  CssClass="form-control" TextMode="MultiLine"  runat="server"></asp:TextBox>
	...
	ORDER BY id
   ) row_num,* FROM [Topics] WHERE (([IsActive] = @IsActive) AND ([IsFinish] = @IsFinish) and DeptAccerdationEmployeeID is  not null and StudentAffAccerdationEmployeeID is null)">
                    <SelectParameters>
...
<%--                                                                <asp:ListItem Value="-1">اختر</asp:ListItem>--%>
	...
	ORDER BY id
   ) row_num,* FROM [Topics] WHERE (([IsActive] = @IsActive) AND ([IsFinish] = @IsFinish) and StudentAffAccerdationEmployeeID is not null)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="True" Name="IsActive" Type="Boolean" />
                        <asp:Parameter DefaultValue="False" Name="IsFinish" Type="Boolean" />
                    </SelectParameters>
