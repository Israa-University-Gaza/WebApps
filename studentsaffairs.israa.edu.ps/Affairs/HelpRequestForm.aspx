<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="HelpRequestForm.aspx.cs" Inherits="Affairs_HelpRequestForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        <li>
            ...
            <a href="Default.aspx" class="font-ha">شئون الطلبة </a>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>نموذج طلب مساعدة للطالب/ <asp:Label ID="StudentName" runat="server" Text=""></asp:Label> </div>
                </div>
                    ...
                    <div class="form-horizontal">
                           <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource5" ConnectionString='<%$ ConnectionStrings:isra2 %>' SelectCommand="SELECT [ID], [ArName] FROM [ConstantDetails] WHERE ([ConstantID] = @ConstantID)">
                                    <SelectParameters>
                       ...
                       <h3 class="inlineh"><i class="fa fa-paste (alias)" style="margin: 0 20px!important"></i>معلومات عن الأسرة </h3>
                        ...
                        <div class="clearfix"></div>
                         <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:isra2 %>' SelectCommand="SELECT [ID], [ArName] FROM [ConstantDetails] WHERE ([ConstantID] = @ConstantID)">
                                    <SelectParameters>
                        ...
                        <div class="clearfix"></div>
                           <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString='<%$ ConnectionStrings:isra2 %>' SelectCommand="SELECT [ID], [ArName] FROM [ConstantDetails] WHERE ([ConstantID] = @ConstantID)">
                                    <SelectParameters>
                        ...
                        <div class="clearfix"></div>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:isra2 %>' SelectCommand="SELECT [ID], [ArName] FROM [ConstantDetails] WHERE ([ConstantID] = @ConstantID)">
                                    <SelectParameters>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:isra2 %>' SelectCommand="SELECT [ID], [ArName] FROM [ConstantDetails] WHERE ([ConstantID] = @ConstantID)">
                                    <SelectParameters>
