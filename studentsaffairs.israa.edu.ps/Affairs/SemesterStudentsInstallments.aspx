<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="SemesterStudentsInstallments.aspx.cs" Inherits="Affairs_SemesterStudentsInstallments" %>
            ...
            <div class="portlet box red">
                ...
                <div class="portlet-body form">
                    <div class="form-horizontal">
                        <div class="form-body" style="width: 95%; margin: 0 auto;">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 8%; text-align: center">رقم الجوال</th>
                                            <th scope="col" style="width: 9%; text-align: center">عدد الأقساط</th>
                                            <th scope="col" style="width: 10%; text-align: center">قيمة الأقساط</th>
                                            <th scope="col" style="width: 8%; text-align: center">الرصيد</th>
                                        </tr>
                                    </thead>
                                    <tbody>
