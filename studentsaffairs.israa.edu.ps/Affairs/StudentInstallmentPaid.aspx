<%@ Page Title="" Language="C#" MasterPageFile="~/Affairs/MasterPage.master" AutoEventWireup="true" CodeFile="StudentInstallmentPaid.aspx.cs" Inherits="Affairs_StudentInstallmentPaid" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <ul class="page-breadcrumb breadcrumb  isra-contaner-heder">
        ...
        <li><a href="#" class="font-ha">كشف الأقساط المسددة خلال فنرة محددة</a></li>
    </ul>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-cogs"></i>كشف الأقساط المسددة خلال فنرة محددة</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 10%; text-align: center">تاريخ الدفع</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                ...
                                SelectCommand="GetStudentInstallmentPaid" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                    ...
                    <div style="font-size: 14px; margin-top: 20px;" class="alert alert-info alert-dismissable">
                        <div class="col-xs-11" style="text-align: center">
                            <strong>لا يوجد أقساط مسددة خلال الفترة المحددة</strong>
