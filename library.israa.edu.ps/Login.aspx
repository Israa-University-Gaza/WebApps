...
<head>
    <meta charset="utf-8" />
    <title>المكتبة المركزية  | تسجيل الدخول</title>
...
<body class="login">
    ...
    <form id="form2" runat="server">
        <div class="content">
            ...
            <h3 class="form-title" style="text-align: center">المكتبة المركزية  </h3>
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <asp:TextBox ID="txtUsername" runat="server" placeholder="الرقم الوظيفي" class="form-control placeholder-no-fix"></asp:TextBox>
                </div>
            </div>
            <div class="form-group">
