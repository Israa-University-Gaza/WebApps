<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="borrowDataView.aspx.cs" Inherits="Library_borrowDataView" %>
    ...
    <div class="row">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption font-ha"><i class="fa fa-search"></i>كشف متابعة الاعارة</div>
                <div class="tools">
                                    ...
                                    <thead>
                                        <tr>
                                           <%-- <th style="width: 5%!important; text-align: center">#</th>--%>
                                            <th style="width: 20%!important; ">اسم المستعير </th>
                                              <th style="width: 10%!important; ">رقم المستعير </th>
                                            <th style="width: 25%!important; ">اسم الكتاب</th>
                                            <th style="width: 10%!important;">تاريخ الاعارة</th>
                                            <th style="width: 15%!important; ">تاريخ الارجاع الافتراضي</th>
                                               <th style="width: 20%!important; "> تاريخ الارجاع الفعلي</th>
                                            <th ></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="width: 20%!important;"><%# Eval("DisplayName") %></td>
                                                       <td style="width: 10%!important;"><%# Eval("ClientID") %></td>
                                                    <td style="width: 25%!important;"><%# Eval("BookTitle") %></td>
                                                    <td style="width: 10%!important;"><%# Eval("BorrowDate","{0:yyyy/MM/dd}") %></td>
                                                    <td style="width: 15%!important;"><%# Eval("ReturnDate","{0:yyyy/MM/dd}") %></td>
                                                    <td style="width: 20%!important;"><%# Eval("ActualReturnDate","{0:yyyy/MM/dd}") %></td>
                                        ...
                                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:LibrarySystem %>' SelectCommand="borrowDataView" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="from" PropertyName="Text" DbType="Date" Name="From"></asp:ControlParameter>
                                                <asp:ControlParameter ControlID="to" PropertyName="Text" DbType="Date" Name="To"></asp:ControlParameter>
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                                    </tbody>
                                </table>
