<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="PeriodicBookSurvay.aspx.cs" Inherits="Library_PeriodicBookSurvay" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:LibrarySystem %>' SelectCommand="PeriodicBookSurvay" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
</div>
</asp:Content>
