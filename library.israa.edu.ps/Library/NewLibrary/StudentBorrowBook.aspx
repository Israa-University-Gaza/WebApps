<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="StudentBorrowBook.aspx.cs" Inherits="NewLibrary_StudentBorrowBook" %>
                ...
                <div class="row">
                    <div style="width: 19%; float: right;">
                        <ul class="ver-inline-menu tabbable margin-bottom-10 font-ha">
                            ...
                            <li class="active"><a href="StudentBorrowBook.aspx"><i class="fa fa-edit"></i>استعارة كتاب</a></li>
