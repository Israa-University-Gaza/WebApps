<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeBorrowedBooks.aspx.cs" Inherits="NewLibrary_EmployeeBorrowedBooks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <li>
        ...
        <a href="EmployeeBorrowedBooks.aspx" class="font-ha">الكتب المستعارة للموظف</a>
    </li>
</asp:Content>
                ...
                <div class="row">
                    <div style="width: 19%; float: right;">
                        <ul class="ver-inline-menu tabbable margin-bottom-10 font-ha">
                            ...
                            <li class="active"><a href="EmployeeBorrowedBooks.aspx"><i class="fa fa-edit"></i>الكتب المستعارة</a></li>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:IsraaLibrary %>' SelectCommand="GetClientBorrowedBooks" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="lblEmployeeID" PropertyName="Text" Name="ClientID" Type="Int32"></asp:ControlParameter>
                                                <asp:Parameter DefaultValue="1" Name="BorrowCategoryID" Type="Int32"></asp:Parameter>
