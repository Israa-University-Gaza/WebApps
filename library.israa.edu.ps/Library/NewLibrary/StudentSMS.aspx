<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="StudentSMS.aspx.cs" Inherits="NewLibrary_SendClientSMS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <li>
        ...
        <a href="StudentSMS.aspx" class="font-ha">إرسال رسالة للطالب</a>
    </li>
</asp:Content>
                ...
                <div class="row">
                    <div style="width: 19%; float: right;">
                        <ul class="ver-inline-menu tabbable margin-bottom-10 font-ha">
                            ...
                            <li class="active"><a href="StudentSMS.aspx"><i class="fa fa-edit"></i>ارسال SMS</a></li>
