<%@ Page Title="" Language="C#" MasterPageFile="~/Library/MasterPage.master" AutoEventWireup="true" CodeFile="StudentBorrowedBooks.aspx.cs" Inherits="NewLibrary_StudentBorrowedBooks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <li>
        ...
        <a href="StudentBorrowedBooks.aspx" class="font-ha">الكتب المستعارة للطالب</a>
    </li>
</asp:Content>
                ...
                <div class="row">
                    <div style="width: 19%; float: right;">
                        <ul class="ver-inline-menu tabbable margin-bottom-10 font-ha">
                            ...
                            <li><a href="Student.aspx"><i class="fa fa-home"></i>الصفحة الرئيسية</a></li>
                            <li><a href="StudentBorrowBook.aspx"><i class="fa fa-edit"></i>استعارة كتاب</a></li>
                            <li class="active"><a href="StudentBorrowedBooks.aspx"><i class="fa fa-edit"></i>الكتب المستعارة</a></li>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:IsraaLibrary %>' SelectCommand="GetClientBorrowedBooks" SelectCommandType="StoredProcedure">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="lblStudentID" PropertyName="Text" Name="ClientID" Type="Int32"></asp:ControlParameter>
                                                    <asp:Parameter DefaultValue="2" Name="BorrowCategoryID" Type="Int32"></asp:Parameter>
